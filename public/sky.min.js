let r={},s={};const l=(e,t=!1)=>{const a=t?"div":"p";return e.split("\n").map(e=>e.trim()).join("\n").split("\n\n").filter(e=>""!==e).map(e=>`<${a}>${(o=>{const n={quote:!0,bold:!0,italic:!0};var e=(e,t,a)=>{for(;-1<o.indexOf(e);)o=n[t]?o.replace(e,`<${a}>`):o.replace(e,`</${a}>`),n[t]=!n[t]},t=(t,a)=>o=o.split("\n").map(e=>0===e.trimStart().indexOf(t)?`<${a}>${e.replace(t,"")}</${a}>`:e).join("\n");return t("#### ","h4"),t("### ","h3"),t("## ","h2"),t("# ","h1"),e('"',"quote","q"),e("**","bold","b"),e("*","italic","i"),o=o.trim()})(e)}</${a}>`).join("")},e=(Game.loon={name:"green man",location:"nearSwamp",exitText:"Nice chatting with you",notMet:()=>`
  ...
  `,desc:{talk:"Professor Loon is still here, gathering more sludge into tubes. ",annoyed:"Professor Loon is in mud, looking very annoyed about something"},talk:()=>{A([`
    ...
    `),u({"Enter the cave":()=>{E("caveForceFieldOff")?M("insideCave")():A(`
  ...
  `}),u(o),u({"Climb back up towards the village":M("cityEntrance")}),u({"Enter the swamp":M("nearSwamp")})},Game.library=()=>{A(`
    ...
    `}),u({"Exit the library":M("city")})},Game.nearSwamp=()=>{A(`
      ...
      `),u({"Turn crank":()=>{N("caveForceFieldOff",!0),A(`
        
        The force field control is now in the off position.
        
        `)}})),k(()=>x(25)&&L(["A particularly large bubble pops, filling the air with stench.","A loud POP carries over the water as another bubble explodes."])),u({"Head towards the cave":M("caveMouth",()=>{E("caveForceFieldOff")&&p("nearSwamp",loon)})}),u({"Go to the clean part of the lake":M("lakeSide",()=>{E("caveForceFieldOff")&&p("nearSwamp",loon)})})},Game.myShip={stillHere:!0},Game.cockpit=()=>{A(`
