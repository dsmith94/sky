let r={},s={};const l=(e,t=!1)=>{const a=t?"div":"p";return e.split("\n").map(e=>e.trim()).join("\n").split("\n\n").filter(e=>""!==e).map(e=>`<${a}>${(o=>{const n={quote:!0,bold:!0,italic:!0};var e=(e,t,a)=>{for(;-1<o.indexOf(e);)o=n[t]?o.replace(e,`<${a}>`):o.replace(e,`</${a}>`),n[t]=!n[t]},t=(t,a)=>o=o.split("\n").map(e=>0===e.trimStart().indexOf(t)?`<${a}>${e.replace(t,"")}</${a}>`:e).join("\n");return t("#### ","h4"),t("### ","h3"),t("## ","h2"),t("# ","h1"),e('"',"quote","q"),e("**","bold","b"),e("*","italic","i"),o=o.trim()})(e)}</${a}>`).join("")},e=(Game.loon={name:"green man",location:"nearSwamp",exitText:"Nice chatting with you",notMet:()=>`
  ...
  `,desc:{talk:"Professor Loon is still here, gathering more sludge into tubes. ",annoyed:"Professor Loon is in mud, looking very annoyed about something"},talk:()=>{M([`
    ...
    `]),o("Loon"),e({"Just in time for what?":()=>{M(`
      ...
      `})}}),a("Just in")&&u({"You really can't even give me a tiny hint what you're working on?":()=>{M([`
    ...
    `}),u({"Hey, can I see that crank for a second?":()=>{M(`
        ...
        `})}}),m("merrick")&&a("Just in")&&u({"You know, that Merrick guy at the festival seems like quite a scientist himself":()=>{M(`
          
          Loon snorts. "I can assure you, my friend, Merrick is *no* scientist of any sort."
          
          `),u({"I don't know. He seems on the edge of a breakthrough!":()=>{M(`
            ...
            `),p(""),f("annoyed"),k("Well OK then")}}),u({"If you say so":`
          
          "I'm not worried about competing with that so-called mixologist,"
          said Loon with a chuckle. "We're doing actual science here."
          
          `})}}),k("Have a good day scooping mud")},annoyed:()=>{M(`
    
    "I'm not in the mood to chat right now," said Loon with a scowl.
    
    `),k("Alrighty")}},Game.mavis={name:"giant brain in a jar",exitText:"Thanks for your help",location:"library",superMegaBlastLearning:!1,bookAskCount:0,notMet:()=>`
    ...
    `,talk:()=>{o("Mavis"),M([`
        ...
        `]),u({"Why haven't you got any books?":()=>{s.bookAskCount<2&&(s.bookAskCount+=1),M([`
        ...
        `}),1<s.bookAskCount&&u({"What's the Super MegaBlast Learning Hat?":()=>{s.superMegaBlastLearning=!0,M(`"I shouldn't even mention it," said Mavis, "Because even if you survive
                it, you'll lose everything you learned in like half an hour.`)}}),0<t("What's the Super MegaBlast Learning Hat?")&&u({"Let me try the hat!":['"You could fry your brain, human," said Mavis.',`"I'm serious about the whole brain-frying thing," said Mavis with a growing
                    edge in her voice.`,()=>{M("Ok, you've had it!")}]}),k(s.exitText)}},Game.merrick={name:"frat scientist",location:"festival",exitText:"Uh, carry on I guess",desc:()=>{m("merrick")?M(`
      ...
      `}),u({"What are you mixing?":()=>{M(`
        ...
        `),u({"Let me try it":()=>{M(`
          ...
          `),u({"Blarrf!":()=>{M(`
            ...
            `)}}),u({"Huuurggg!":()=>{M('"Not perfect yet," mumbled Merrick. "Needs more absinthe and strychnine."')}}),u({"Excuse me. Can you direct me to the nearest bipedal-friendly porcelain commode?":()=>{M(`Merrick slowly transforms into an enormous Kafkaesque toilet. "What did you
        ...
        `})}}),k(s.exitText)}},Game.rebnah={exitText:"Nice chatting with you",hasTheToken:!1,location:"cityEntrance",name:"greeter hologram",talkLabel:()=>{var[e,,t,,]=c("rebnah");return`Chat with ${t} `+e},notMet:()=>{return`
      ...
      `},desc:()=>`
        ...
        Rebnah the greeter hologram waves to you cheerily, which is impressive considering her vast quantity of arms. ${L(25)?`She 
              emits a thunderous snort and rubs her fantastic nose.`:""}
              
    `,talk:()=>{s.hasTheToken=!0,M([`
      ...
      `]),o("Rebnah"),u({"Tell me about your home planet":()=>{M([`
    ...
    `}),s.hasTheToken&&e({"Read the token":`
          ...
          `}),k("See you later")},afterShipDestroyed:()=>{M(`
              
    Rebnah the greeter hologram offers a wan smile, seemingly aware that you're having a rough day.
    
    `),u({"Do you just pop in and out of existence like that all the time?":()=>{s.exitText="Well, it's been a... pleasure, I guess",M(`
      ...
      `),u({"That's... horrific...":`
          ...
          `})}}),k(s.exitText)}},Game.spaceKing={preventWar:!1,name:"man",talk:()=>{o("Space King"),M([`
      ...
      `]),e({"Never heard of you":`
        ...
        `}),e({"What's the most impressive thing you've ever done?":()=>{M(`
        ...
        `),u({"Did you have the moral right to create a living thing?":()=>{M(`
          
          "I don't know," responded the Space King, "But, I do know this: he was delicious."
          
          `)}}),u({"What kind of pie was it?":()=>{M(`
      ...
      `}),e({"What are you doing *here* of all places?":()=>{s.preventWar=!0,M(`
      ...
      `})}}),k("A pleasure to talk to you, oh Space King")}},Game.yates={askedAboutName:!1,talk:()=>{s.askedAboutName;M(`
        ...
        `),u({"Tell me again why your name is Yates":()=>{s.askedAboutName=!0,M(`
        ...
        `)}}),u({"Will you hurry up already?":()=>{f("annoyed"),M(`"I'm working as fast as I can," he grumbled.`)}}),k("Well, keep working, we've got to get off this rock",()=>{M("Yates nods and buries himself in repair work. A shadow of paranoia crosses your mind that he may not know what he's doing.")})},annoyed:()=>{M(`
    ...
    `}),u({"Thank you for working so hard, Yates":()=>{f(),M(`
        
        "Thanks. I'm going as fast as I can."
        
        `)}}),k("Well, keep working, we've got to get off this rock")}},Game.caveMouth=()=>{M(`
    ...
    `),u({"Enter the cave":()=>{N("caveForceFieldOff")?x("insideCave")():M(`
            ...
            `)}}),u({"Return to the swamp":x("nearSwamp")})},Game.city=()=>{M(`
    ...
    `),T(()=>L(25)&&E(["Boom! Boom! Boom! The base from the micro-sized festival echoes down the street.",`You can hear what sounds like tiny screams from the festival ahead. Either people are
    ...
    `}),u({"Find the repair shop":x("shipRepairShop")}),u({"Enter the library":x("library")}),u({"Walk to the festival":()=>{M(`Your skin tingles a bit as you pass through a compression field and
      are shrunk to a couple of millimeters tall
      so as to enter the venue.`),u({"Hey that tickles":x("festival")})}}),u({"Leave the village":x("cityEntrance")})},Game.cityEntrance=()=>{M(`
    ...
    `),T(()=>L(25)&&E(["A door quietly shuts somewhere beyond the wall.","The wind whips just enough around the walls to produce a low, sad whistle."])),e({"Read the 1000 meter tall sign":`
    The writing is small, you'll have to get closer by heading towards the lake.
  `}),u({"Head up the hill":x("outsideShip")}),u({"Follow the path to the lake":x("lakeSide")}),u({"Enter the village":x("city")})},Game.festival=()=>{M(`
    ...
    `),T(()=>L(25)&&E(["An explosion of confetti fills the air, with several colored bits landing on your face.","The crowd cheers, as though someone either drank another flight or passed out."])),u({"Dance with the crowd":`
  ...
  `}),u({"Listen to the music":`
    ...
    It's tough to hear any lyrics, but it sounds like the ${E([`3rd Movement of Parnassor the Tuneless Suicidal on the Great Ending of Everything Ever.
  ...
  `}),u({"Leave the festival":x("city")})},Game.lakeSide=()=>{var[e,t,a]=c("spaceKing"),o={};o[y("spaceKing")]=v("spaceKing"),M(`
  ...
  `),T(()=>L(25)&&E(["The wind creates soft little ripples over the lake.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),u({"Read the incredible sign":`
  ...
  `}),u(o),u({"Climb back up towards the village":x("cityEntrance")}),u({"Enter the swamp":x("nearSwamp")})},Game.library=()=>{M(`
    ...
    `}),u({"Exit the library":x("city")})},Game.nearSwamp=()=>{M(`
      ...
      `),u({"Turn crank":()=>{H("caveForceFieldOff",!0),M(`
        
        The force field control is now in the off position.
        
        `)}})),T(()=>L(25)&&E(["A particularly large bubble pops, filling the air with stench.","A loud POP carries over the water as another bubble explodes."])),u({"Head towards the cave":x("caveMouth",()=>{N("caveForceFieldOff")&&p("nearSwamp",loon)})}),u({"Go to the clean part of the lake":x("lakeSide",()=>{N("caveForceFieldOff")&&p("nearSwamp",loon)})})},Game.myShip={stillHere:!0},Game.cockpit=()=>{M(`
    ...
    `),u({"Climb down to the Main Deck":x("mainDeck")}),u({"Sit in the chair":"You sit in the command chair and feel very heroic."}),u({"Look out the window":"The purple sky and distant golden mountains don't resemble any planet you've visited before."})},Game.mainDeck=()=>{M(`
    ...
    `),u({"Go to the cockpit":x("cockpit")}),u({"Exit the ship":x("outsideShip")})},Game.outsideShip=()=>{M(`
    ...
    `),w()&&L(50)&&M(E(["A big pink cloud poofs on by over the horizon.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),u({"Hey, Yates":v("yates")}),u({"Admire the view":`
  ...
  `}),u({"Assess my ship":`
    ...
    this morning's landing not withstanding. Currently, Yates ${E(["has coolant spilled all over the hull","is tightening bolts on a rusted structural support","is pulling a fuel hose from under the engine"])}.
    
    `}),u({"Enter the ship":x("mainDeck")}),u({"Go down to the village":x("cityEntrance")})},Game.shipRepairShop=()=>{M(`
  ...
  `}),u({"Return to the village":x("city")})},Game.start=()=>{M(`
    ...
    `),u({Start:x("intro1")})},Game.intro1=()=>{M(`
    ...
    `),u({"Ugghh... It's too early for an emergency...":x("intro2")})},Game.intro2=()=>{M(`
    ...
    `),u({"Yates! What happened?":x("intro3")})},Game.intro3=()=>{M(`
