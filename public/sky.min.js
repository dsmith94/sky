Game.loon={name:"green man",location:"nearSwamp",exitText:"Nice chatting with you",notMet:()=>b(`
  ...
  `),talk:()=>{w(`
    ...
    `),e("Loon"),a("Just in time for what?",()=>{b(`
    ...
    `),p("Have a good day scooping mud")}},Game.merrick={name:"frat scientist",location:"festival",exitText:"Uh, carry on I guess",desc:()=>{l("merrick")?b(`
      ...
      `),e("Merrick"),s("What are you mixing?",()=>{b(`
        ...
        `)}),p(u.exitText)}},Game.rebnah={exitText:"Nice chatting with you",hasTheToken:!1,name:"greeter hologram",notMet:()=>{var e="She has numerous arms in inconvenient places and a noggin which resembles that of a reasonably pleased purple rhinoceros.";w(`
            
      One of those weird greeter holograms has popped out of thin air. ${e}
            
      `,`
            
      That greeter hologram is trying to get your attention. ${e}
    ...
    `)},talk:()=>{u.hasTheToken=!0,w(`
          ...
          `),e("Rebnah"),s("Tell me about your home planet",()=>{w(`
      ...
      `),u.hasTheToken&&a("Read the token",()=>{b(`
    ...
    `),s("Do you just pop in and out of existence like that all the time?",()=>{u.exitText="Well, it's been a... pleasure, I guess",b(`
      ...
      `)}),p(u.exitText)}},Game.spaceKing={preventWar:!1,name:"man",talk:()=>{e("Space King"),w(`
        ...
        `),a("What's the most impressive thing you've ever done?",()=>{b(`
        ...
        `),s("Did you have the moral right to create a living thing?",()=>{b(`
          ...
          `)})}),u.preventWar&&s("So what are you doing to prevent war?",`
              ...
              `),a("What are you doing *here* of all places?",()=>{u.preventWar=!0,b(`
        ...
        `)}),p("A pleasure to talk to you, oh Space King")}},Game.yates={askedAboutName:!1,talk:()=>{var e=u.askedAboutName?"Tell me again why your name is Yates":"So, I've never asked: why are you named *Yates*?";b(`
        ...
        `)}),s("Will you hurry up already?",()=>{t("yates","annoyed"),b(`"I'm working as fast as I can," he grumbled.`)}),p("Well, keep working, we've got to get off this rock")},annoyed:()=>{b(`
      ...
      `),s("Thank you for working so hard, Yates",()=>{t("yates","talk"),b(`
    ...
    `),s("Find the repair shop",()=>y("shipRepairShop")),s("Walk to the festival",()=>{b(`Your skin tingles a bit as you pass through a compression field and are shrunk to a couple of millimeters tall
      so as to enter the venue.`),s("Hey that tickles",()=>y("festival"))}),s("Leave the village",()=>y("cityEntrance"))},Game.cityEntrance=()=>{var[e,,t,,]=r("rebnah");b(`
    ...
    `),h("rebnah"),v(50)&&b(k(["A door quietly shuts somewhere beyond the wall.","The wind whips just enough around the walls to produce a low, sad whistle."])),s(`Chat with ${t} `+e,()=>g("rebnah")),a("Read the 1000 meter tall sign","The writing is small, you'll have to get closer by heading towards the lake."),s("Head up the hill",()=>y("outsideShip")),s("Follow the path to the lake",()=>y("lakeSide")),s("Enter the village",()=>y("city"))},Game.festival=()=>{var[e,,t,,]=r("merrick");b(`
    ...
    `),h("merrick"),v(50)&&b(k(["An explosion of confetti fills the air, with several colored bits landing on your face.","The crowd cheers, as though someone either drank another flight or passed out."])),s(`Talk to ${t} `+e,()=>g("merrick")),s("Dance with the crowd","OOF! OUCH! HMPH! Arms, legs and tentacles flail around you as you attempt to cut a rug."),s("Listen to the music","It's tough to hear any lyrics, but it sounds like the "+k([`3rd Movement of Parnassor the Tuneless Suicidal on the Great Ending of Everything Ever.
        ...
        wrote only polkas.`])),s("Leave the festival",()=>y("city"))},Game.lakeSide=()=>{var[e,t,a]=r("spaceKing");b(`
  ...
  **Here He Is**
  ...
  `),s(`Speak to ${a} `+e,()=>g("spaceKing")),s("Climb back up towards the village",()=>y("cityEntrance")),s("Enter the swamp",()=>y("nearSwamp"))},Game.nearSwamp=()=>{var[e,,t,,]=r("loon"),a=d.loon.location===m;b(`
      ...
      `),a&&h("loon"),v(50)&&b(k(["A particularly large bubble pops, filling the air with stench.","A loud POP carries over the water as another bubble explodes."])),a&&s(`Talk to ${t} `+e,()=>g("loon")),s("Head towards the cave",()=>y("cave")),s("Go to the clean part of the lake",()=>y("lakeSide"))},Game.myShip={stillHere:!0},Game.cockpit=()=>{b(`
    ...
    `),s("Climb down to the Main Deck",()=>y("mainDeck")),s("Sit in the chair","You sit in the command chair and feel very heroic."),s("Look out the window","The purple sky and distant golden mountains don't resemble any planet you've visited before.")},Game.mainDeck=()=>{b(`
    ...
    `),s("Go to the cockpit",()=>y("cockpit")),s("Exit the ship",()=>y("outsideShip"))},Game.outsideShip=()=>{d.myShip.stillHere?(b(`
    ...
    `),s("Go down to the village",()=>y("cityEntrance"))},Game.shipRepairShop=()=>{b(`
    ...
    `),s("Read the sign on the door",`
      ...
      `),s("Return to the village",()=>y("city"))},Game.start=()=>{b(`

    # We Might All Die on Snorlag
    
    ## A game by spaceflounder
    
    `),s("Start",()=>y("intro1"))},Game.intro1=()=>{b(`
    ...
    `),s("Ugghh... It's too early for an emergency...",()=>y("intro2"))},Game.intro2=()=>{b(`
    ...
    `),s("Yates! What happened?",()=>y("intro3"))};let n=!(Game.intro3=()=>{b(`
    ...
    `),s("Did you say two weeks?",()=>y("outsideShip"))});const a=(t,e)=>{const a="d"+function(){var e=0;if(0!=t.length)for(i=0;i<t.length;i++)e=(e<<5)-e+(char=t.charCodeAt(i)),e&=e;return e}();d[a]||s(t,()=>{d[a]=!0,b(e)})},s=(e,t)=>{var a,o=document.getElementById("card");o&&e&&t&&(e=e.trim(),(a=document.createElement("button")).onclick=()=>{f(),n=!0,window.scrollTo(0,0),b(t),!(n=""===document.getElementById("card").innerHTML?!1:n)&&c&&s("✔",()=>{c&&c()})},a.className="button",a.innerHTML=`<div class='buttonText'>${T(e,!0)}</div>`,o.appendChild(a))},o=e=>e[0].toUpperCase()+e.slice(1),r=e=>{e=e||d.isTalking;var t=d[e].a??"a",a=d[e].the??"the",o=d[e].that??"that";return[d[e].name??"man",t,a,o]},e=(e,t)=>{t=t||d.isTalking,d[t].a="",d[t].the="",d[t].that="",d[t].name=e},l=e=>(e=e||d.isTalking,d[e].hasMet),h=e=>{if(e=e||d.isTalking,!l(e)&&d[e].notMet)return"function"==typeof d[e].notMet?d[e].notMet():d[e].notMet??o(`${a} ${t} is here.`);if("function"==typeof d[e].desc)return d[e].desc();const[t,,a]=r(e);return d[e].desc??o(`${a} ${t} is here.`)};let d={},u={},c=()=>{},m="";const y=e=>{n=!0,m=e,d[e](),c=d[e]},t=(e,t)=>{t=t??"_";d[e].state=t,d.isTalking===e&&(c=d[e][t])},g=e=>{d.isTalking=e,(u=d[e]).hasMet=!0;var t=u?.state??"_";n=!0,d[e][t](),c=d[e][t]},p=e=>s(e,()=>{y(m),d.isTalking=""}),f=()=>{document.getElementById("page").innerHTML="",document.getElementById("card").innerHTML=""},w=(t,e)=>{var a="i"+function(){var e=0;if(0!=t.length)for(i=0;i<t.length;i++)e=(e<<5)-e+(char=t.charCodeAt(i)),e&=e;return e}();d[a]?b(e):(d[a]=!0,b(t))},b=e=>{"string"==typeof e?document.getElementById("page").innerHTML+=T(e):"function"==typeof e&&e()},v=e=>e>=Math.floor(100*Math.random());const k=e=>{return(e=>{let t=e.length,a;for(;0!=t;)a=Math.floor(Math.random()*t),t--,[e[t],e[a]]=[e[a],e[t]];return e})([...e])[0]},T=(e,t=!1)=>{const a=t?"div":"p";return e.split("\n").map(e=>e.trim()).join("\n").split("\n\n").filter(e=>""!==e).map(e=>`<${a}>${(o=>{const i={quote:!0,bold:!0,italic:!0};var e=(e,t,a)=>{for(;-1<o.indexOf(e);)o=i[t]?o.replace(e,`<${a}>`):o.replace(e,`</${a}>`),i[t]=!i[t]},t=(t,a)=>o=o.split("\n").map(e=>0===e.trimStart().indexOf(t)?`<${a}>${e.replace(t,"")}</${a}>`:e).join("\n");return t("#### ","h4"),t("### ","h3"),t("## ","h2"),t("# ","h1"),e('"',"quote","q"),e("**","bold","b"),e("*","italic","i"),o=o.trim()})(e)}</${a}>`).join("")};window.addEventListener("load",()=>{d={...Game},y("start")});