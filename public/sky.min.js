let n=!1;const t=()=>{if(!n){const a=document.createElement("div"),o=(a.className="menu",document.createElement("div"));o.style=`
      ...
      align-items: center;
    `;let e=[];r.map&&(e=r.map.sort().filter(e=>r[e]?.location!==r.currentLocationName)).map(t=>{var e;r[t].location&&((e=document.createElement("button")).innerText=r[t].name,e.style="width: 80vw;",e.onclick=()=>{const e=document.createElement("div");e.className="outMenu",e.innerHTML=a.innerHTML,n=!1,a.remove(),d(),u(),M(r[t].location)(),document.body.appendChild(e),setTimeout(()=>{e.remove()},400)},o.appendChild(e))});var t=document.createElement("button");t.style="aspect-ratio: 1; font-size: 32pt; font-weight: bold; width: 64px; height: 64px;",t.innerText="⤒",t.onclick=()=>{n=!1,a.remove();const e=document.createElement("div");e.className="outMenu",e.innerHTML=a.innerHTML,document.body.appendChild(e),setTimeout(()=>{e.remove()},400)},0<e.length&&(o.appendChild(t),a.appendChild(o),document.body.appendChild(a))}};let r={},s={};const l=(e,t=!1)=>{const a=t?"div":"p";return e.split("\n").map(e=>e.trim()).join("\n").split("\n\n").filter(e=>""!==e).map(e=>`<${a}>${(o=>{const n={quote:!0,bold:!0,italic:!0};var e=(e,t,a)=>{for(;-1<o.indexOf(e);)o=n[t]?o.replace(e,`<${a}>`):o.replace(e,`</${a}>`),n[t]=!n[t]},t=(t,a)=>o=o.split("\n").map(e=>0===e.trimStart().indexOf(t)?`<${a}>${e.replace(t,"")}</${a}>`:e).join("\n");return t("#### ","h4"),t("### ","h3"),t("## ","h2"),t("# ","h1"),e('"',"quote","q"),e("**","bold","b"),e("*","italic","i"),o=o.trim()})(e)}</${a}>`).join("")};function h(e){var t=0;if(0!=e.length)for(i=0;i<e.length;i++)t=(t<<5)-t+(char=e.charCodeAt(i)),t&=t;return t}Game.loon={name:"green man",location:"nearSwamp",exitText:"Nice chatting with you",notMet:()=>`
  ...
  `,desc:{talk:"Professor Loon is still here, gathering more sludge into tubes. ",annoyed:"Professor Loon is in mud, looking very annoyed about something"},talk:()=>{A([`
    ...
    `]),g("Loon"),e({"Just in time for what?":()=>{A(`
      ...
      `})}}),o("Just in")&&c({"You really can't even give me a tiny hint what you're working on?":()=>{A([`
    ...
    `}),c({"Loon is an unusual name, where are you from?":`
    ...
    `}),c({"Hey, can I see that crank for a second?":()=>{A(`
        ...
        `}),c({"I don't think you're going to find anything tromping in the mud anyway":`
        ...
        `})}}),p("merrick")&&o("Just in")&&c({"You know, that Merrick guy at the festival seems like quite a scientist himself":()=>{A(`
          
          Loon snorts. "I can assure you, my friend, Merrick is *no* scientist of any sort."
          
          `),c({"I don't know. He seems on the edge of a breakthrough!":()=>{A(`
            ...
            `),w(""),b("annoyed"),I("Well OK then")}}),c({"If you say so":`
          
          "I'm not worried about competing with that so-called mixologist,"
          said Loon with a chuckle. "We're doing actual science here."
          
          `})}}),I("Have a good day scooping mud")},annoyed:()=>{A(`
    
    "I'm not in the mood to chat right now," said Loon with a scowl.
    
    `),I("Alrighty")}},Game.mavis={name:"giant brain in a jar",exitText:"Thanks for your help",location:"library",superMegaBlastLearning:!1,bookAskCount:0,notMet:()=>`
    ...
    `,talk:()=>{g("Mavis"),A([`
        ...
        `]),c({"Why haven't you got any books?":()=>{s.bookAskCount<2&&(s.bookAskCount+=1),A([`
            ...
            `])}}),o("any books")&&c({"Are you sure you don''t have any books?":`
        
        "It's not that kind of library," said Mavis.
        
        `}),1<s.bookAskCount&&c({"What's the Super MegaBlast Learning Hat?":()=>{s.superMegaBlastLearning=!0,A(`"I shouldn't even mention it," said Mavis, "Because even if you survive
                it, you'll lose everything you learned in like half an hour.`)}}),0<a("What's the Super MegaBlast Learning Hat?")&&c({"Let me try the hat!":['"You could fry your brain, human," said Mavis.',`"I'm serious about the whole brain-frying thing," said Mavis with a growing
                    edge in her voice.`,()=>{A("Ok, you've had it!")}]}),I(s.exitText)}},Game.merrick={name:"frat scientist",location:"festival",exitText:"Uh, carry on I guess",desc:()=>{p("merrick")?A(`
      ...
      `]),g("Merrick"),c({"Are you working the bar all by yourself?":`
      ...
      `}),c({"What are you mixing?":()=>{A(`
        ...
        `),c({"Let me try it":()=>{A(`
          ...
          `),c({"Blarrf!":()=>{A(`
            ...
            `)}}),c({"Huuurggg!":()=>{A('"Not perfect yet," mumbled Merrick. "Needs more absinthe and strychnine."')}}),c({"Excuse me. Can you direct me to the nearest bipedal-friendly porcelain commode?":()=>{A(`Merrick slowly transforms into an enormous Kafkaesque toilet. "What did you
            say again?" he asked. His seat and lid were acting as a tongue and mouth.`)}})}}),c({"It looks like scummy swamp water":`
        
        "Wow, you're a mixologist as well?" said Merrick, obviously impressed. "Not bad."
        
        `})}}),I(s.exitText)}},Game.rebnah={exitText:"Nice chatting with you",hasTheToken:!1,location:"cityEntrance",name:"greeter hologram",talkLabel:()=>{var[e,,t,,]=y("rebnah");return`Chat with ${t} `+e},notMet:()=>{return`
    ...
    `,talk:()=>{s.hasTheToken=!0,A([`
      ...
      `]),g("Rebnah"),c({"Tell me about your home planet":()=>{A([`
    ...
    `}),s.hasTheToken&&e({"Read the token":`
          ...
          `}),I("See you later")},afterShipDestroyed:()=>{A(`
              
    Rebnah the greeter hologram offers a wan smile, seemingly aware that you're having a rough day.
    
    `),c({"Do you just pop in and out of existence like that all the time?":()=>{s.exitText="Well, it's been a... pleasure, I guess",A(`
      ...
      `),c({"That's... horrific...":`
          ...
          `})}}),I(s.exitText)}},Game.spaceKing={preventWar:!1,name:"man",talk:()=>{g("Space King"),A([`
      ...
      `})}}),I("A pleasure to talk to you, oh Space King")}},Game.yates={askedAboutName:!1,talk:()=>{s.askedAboutName;A(`
        ...
        `),c({"Tell me again why your name is Yates":()=>{s.askedAboutName=!0,A(`
        ...
        `)}}),c({"Will you hurry up already?":()=>{b("annoyed"),A(`"I'm working as fast as I can," he grumbled.`)}}),I("Well, keep working, we've got to get off this rock",()=>{A("Yates nods and buries himself in repair work. A shadow of paranoia crosses your mind that he may not know what he's doing.")})},annoyed:()=>{A(`
    ...
    `}),c({"Thank you for working so hard, Yates":()=>{b(),A(`
        
        "Thanks. I'm going as fast as I can."
        
        `)}}),I("Well, keep working, we've got to get off this rock")}},Game.caveMouth=()=>{A(`
    ...
    `),c({"Enter the cave":()=>{N("caveForceFieldOff")?M("insideCave")():A(`
            ...
            `)}}),c({"Return to the swamp":M("nearSwamp")})},Game.city=()=>{A(`
    ...
    `),S(()=>x(25)&&L(["Boom! Boom! Boom! The base from the micro-sized festival echoes down the street.",`You can hear what sounds like tiny screams from the festival ahead. Either people are
      depressed over the end of the universe or they're having a pretty good time.`,"The music peaks from the festival, followed by a small but thunderous cheer."])),c({"Read the hastily scrawled sign":`
    ...
    `}),c({"Find the repair shop":M("shipRepairShop")}),c({"Enter the library":M("library")}),c({"Walk to the festival":()=>{A(`Your skin tingles a bit as you pass through a compression field and
      are shrunk to a couple of millimeters tall
      so as to enter the venue.`),c({"Hey that tickles":M("festival")})}}),c({"Leave the village":M("cityEntrance")})},Game.cityEntrance=()=>{A(`
    ...
    `),S(()=>x(25)&&L(["A door quietly shuts somewhere beyond the wall.","The wind whips just enough around the walls to produce a low, sad whistle."])),e({"Read the 1000 meter tall sign":`
    The writing is small, you'll have to get closer by heading towards the lake.
  `}),c({"Head up the hill":M("outsideShip")}),c({"Follow the path to the lake":M("lakeSide")}),c({"Enter the village":M("city")})},Game.festival=()=>{A(`
    ...
    `),S(()=>x(25)&&L(["An explosion of confetti fills the air, with several colored bits landing on your face.","The crowd cheers, as though someone either drank another flight or passed out."])),c({"Dance with the crowd":`
  ...
  `}),c({"Leave the festival":M("city")})},Game.lakeSide=()=>{var[e,t,a]=y("spaceKing"),o={};o[f("spaceKing")]=T("spaceKing"),A(`
  ...
  `),S(()=>x(25)&&L(["The wind creates soft little ripples over the lake.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),c({"Read the incredible sign":`
  ...
  `}),c(o),c({"Climb back up towards the village":M("cityEntrance")}),c({"Enter the swamp":M("nearSwamp")})},Game.library=()=>{A(`
    ...
    `}),c({"Exit the library":M("city")})},Game.nearSwamp=()=>{A(`
      ...
      `),c({"Turn crank":()=>{H("caveForceFieldOff",!0),A(`
        
        The force field control is now in the off position.
        
        `)}})),S(()=>x(25)&&L(["A particularly large bubble pops, filling the air with stench.","A loud POP carries over the water as another bubble explodes."])),c({"Head towards the cave":M("caveMouth",()=>{N("caveForceFieldOff")&&w("nearSwamp",loon)})}),c({"Go to the clean part of the lake":M("lakeSide",()=>{N("caveForceFieldOff")&&w("nearSwamp",loon)})})},Game.myShip={stillHere:!0},Game.cockpit=()=>{A(`
    ...
    `),c({"Climb down to the Main Deck":M("mainDeck")}),c({"Sit in the chair":"You sit in the command chair and feel very heroic."}),c({"Look out the window":"The purple sky and distant golden mountains don't resemble any planet you've visited before."})},Game.mainDeck=()=>{A(`
    ...
    `),c({"Go to the cockpit":M("cockpit")}),c({"Exit the ship":M("outsideShip")})},Game.outsideShip=()=>{A(`
    ...
    `),k()&&x(50)&&A(L(["A big pink cloud poofs on by over the horizon.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),c({"Hey, Yates":T("yates")}),c({"Admire the view":`
  ...
  `}),c({"Assess my ship":`
    ...
    `}),c({"Enter the ship":M("mainDeck")}),c({"Go down to the village":M("cityEntrance")})},Game.shipRepairShop=()=>{A(`
  ...
  `),c({"Read the sign on the door":`
      
    <center>*Closed until the universe ends*</center>

  `}),c({"Enter the repair shop":`
      
    The door is shut and locked tight.
      
  `}),c({"Return to the village":M("city")})},Game.start=()=>{A(`
    ...
    `),c({Start:M("intro1")})},Game.intro1=()=>{A(`
    ...
    `),c({"Ugghh... It's too early for an emergency...":M("intro2")})},Game.intro2=()=>{A(`
    ...
    `),c({"Yates! What happened?":M("intro3")})},Game.intro3=()=>{A(`
    ...
    `),c({"Did you say two weeks?":M("outsideShip")})},window.addEventListener("load",()=>{var e;r={...Game},(e=document.createElement("div")).className="topBar",e.onclick=t,document.body.appendChild(e),u(),M("start")()});const e=e=>{let t=Object.keys(e)[0];const a="d"+h(t);var o;r[a]||((o={})[t]=()=>{r[a]=!0,"function"==typeof e[t]?e[t]():A(e[t])},c(o))},d=()=>{document.getElementsByClassName("main")[0].remove(),window.scrollTo(0,0),r.buttonCount=0};const u=()=>{var e=document.createElement("div"),t=document.createElement("div"),a=document.createElement("btns");e.className="main",e.id="main",t.className="page",t.id="page",a.className="btns",a.id="btns",document.body.appendChild(e),e.appendChild(t),e.appendChild(a)},c=e=>{var t=document.getElementById("btns");let o="",n=null;const a=["unshift"];if("object"==typeof e&&(o=Object.keys(e).filter(e=>-1===a.indexOf(e))[0],n=e[o]),!(t&&o&&n))throw"Button could not be constructed! With options: "+JSON.stringify(e);r.buttonCount||(r.buttonCount=0),r.buttonCount+=1,o=o.trim();var i=document.createElement("button"),e=(i.type="button",i.onclick=()=>{var e,t=document.getElementsByClassName("main")[0].innerHTML,a=(d(),r.isTalking&&(a=s?.state??"talk",e=s[a]["btn-"+o]??0,r.lastButtonPressed=o,s[a]["btn-"+o]=e+1),document.createElement("div"));a.className="outPage",a.id="outPage",a.innerHTML=t,document.body.appendChild(a),setTimeout(()=>{document.getElementById("outPage").remove(),u(),"function"==typeof n?n():A(n),!r.env||!r.isTalking&&r.buttonCount||A(r.env()),!r.buttonCount&&r.lastNode&&c({"➜":()=>{r.lastNode&&r.lastNode()}})},450)},i.className="button",i.innerHTML=`<div class='buttonText'>${l(o,!0)}</div>`,e.unshift);e?t.prepend(i):t.appendChild(i)},m=e=>e[0].toUpperCase()+e.slice(1),a=(e,t,a)=>{return e=e||r.lastButtonPressed,t=t||r.isTalking,a=a||(s.state??"talk"),r[t][a]["btn-"+e]??0},o=(o,t,e)=>{t=t||r.isTalking;var a=e=>{for(const t of e)if(Array.isArray(o)){for(const a of o)if(-1<t.indexOf(a))return!0}else if(-1<t.indexOf(o))return!0;return!1};if("*"!==(e=e||"*"))return a(Object.keys(r[t][e]).filter(e=>"function"==typeof e).filter(e=>-1<e.indexOf("btn-")));for(const n of Object.keys(r[t]))if(a(Object.keys(r[t][n]).filter(e=>"number"==typeof r[t][n][e]).filter(e=>-1<e.indexOf("btn-"))))return!0;return!1},y=e=>{e=e||r.isTalking;var t=r[e].a??"a",a=r[e].the??"the",o=r[e].that??"that";return[r[e].name??"person",t,a,o]},g=(e,t)=>{t=t||r.isTalking,r[t].a="",r[t].the="",r[t].that="",r[t].name=e},p=e=>(e=e||r.isTalking,r[e].hasMet),f=e=>{e=e||r.isTalking;var[t,,a,,]=y(e);return r[e].talkLabel?"string"==typeof r[e].talkLabel?r[e].talkLabel:r[e].talkLabel():`Talk to ${a} `+t},v=e=>{return(e?r[e]:s).location},w=(e,t)=>{(t?r[t]:s).location=e},b=(e,t)=>{e=e??"talk";t=t||r.isTalking,r[t].state=e,r.isTalking===t&&(r.lastNode=r[t][e])},k=e=>{return e=e||r.currentLocationName,r[e].visited??0},T=a=>()=>{r.isTalking=a,(s=r[a]).hasMet=!0;var e,t=s?.state??"talk";e=e||r.isTalking,r.map||(r.map=[]),r[e]&&r[e].location&&-1===r.map.indexOf(e)&&r.map.push(e),1!==r?.map?.length||r.showFastTravelTip||(r.showFastTravelTip=1),r[a][t](),r.lastNode=r[a][t]},I=(e,t)=>{var a={};a[e]=()=>{t?(t(),c({"➜":()=>{M(r.currentLocationName)(),r.isTalking=""}})):(M(r.currentLocationName)(),r.isTalking="")},c(a)},S=e=>{r.env=e},A=e=>{var t=document.getElementById("page");if(t)if(Array.isArray(e)){var a=e;const s=a[0];var o="i"+(()=>{let e=0;if(0!=s.length)for(i=0;i<s.length;i++){var t=s.charCodeAt(i);e=(e<<5)-e+t,e&=e}return e})(),n=r[o]??0;n?(A(a[n]),n<a.length-1&&(r[o]=n+1)):(r[o]=1,A(s))}else"string"==typeof e?t.innerHTML+=l(e):"function"==typeof e&&(t.innerHTML+=l(e()))},M=t=>{const a=()=>{Object.keys(r).map(e=>{var t;r[e]?.location&&r.currentLocationName===r[e]?.location&&(t=(e=>{e=e||r.isTalking;var[t,,a]=y(e),o=r[e].state??"talk";if(!p(e)&&r[e].notMet){if("function"==typeof r[e].notMet)return r[e].notMet();if("object"==typeof r[e].notMet&&r[e].notMet[o]){if("function"==typeof r[e].notMet[o])return r[e].notMet[o]();if("string"==typeof r[e].notMet[o])return r[e].notMet[o]}return r[e].notMet??m(a+` ${t} is here.`)}if("function"==typeof r[e].desc)return r[e].desc();if("object"==typeof r[e].desc&&r[e].desc[o]){if("function"==typeof r[e].desc[o])return r[e].desc[o]();if("string"==typeof r[e].desc[o])return r[e].desc[o]}return r[e].desc??m(a+` ${t} is here.`)})(e),A(t),r[e].talk)&&((t={})[f(e)]=T(e),t.unshift=!0,c(t))})};return()=>{r.currentLocationName=t;var e=()=>{var e=r[t]?.visited??0;r.env=null,r.isTalking="",r[t](),a(),r[t].visited=e+1,1===r.showFastTravelTip&&r[r.map[0]].location!==r.currentLocationName&&(r.showFastTravelTip=2,E("Hey there! You can now fast travel to characters you meet by tapping the top ⤴ of the screen"))};e(),r.lastNode=e}},x=e=>e>=Math.floor(100*Math.random());const L=e=>{var t=`p{${h(e.join("-"))}}`;return r[t]&&r[t]?.length||(r[t]=(e=>{let t=e.length,a;for(;0!=t;)a=Math.floor(Math.random()*t),t--,[e[t],e[a]]=[e[a],e[t]];return e})([...e])),r[t].pop()},E=e=>{const t=document.createElement("div");t.className="tipBox",t.id="tipBox";var a=document.createElement("div"),o=(a.className="tipInnerBox",a.id="tipInnerBox",document.createElement("div"));o.className="tipInnerText",o.id="tipInnerText",o.innerText=e,a.appendChild(o),t.appendChild(a),t.onclick=()=>t.remove(),document.body.appendChild(t)},N=e=>(r.values||(r.values={}),r.values[e]??!1),H=(e,t)=>{r.values||(r.values={}),r.values[e]=t};