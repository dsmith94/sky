Game.loon={name:"green man",location:"nearSwamp",exitText:"Nice chatting with you",notMet:()=>k(`
  ...
  `),talk:()=>{k([`
    ...
    `]),a("Loon"),e({"Just in time for what?":()=>{k(`
    ...
    `}),w("Have a good day scooping mud")}};Game.mavis={name:"giant brain in a jar",exitText:"Thanks for your help",location:"library",superMegaBlastLearning:!1,bookAskCount:0,notMet:()=>`
    ...
    `,talk:()=>{k([`
        ...
        `]),h({"Why haven't you got any books?":()=>{y.bookAskCount<2&&(y.bookAskCount+=1),k([`
            ...
            `])}}),1<y.bookAskCount&&h({"What's the Super MegaBlast Learning Hat?":()=>{y.superMegaBlastLearning=!0,k(`"I shouldn't even mention it," said Mavis, "Because even if you survive
                it, you'll lose everything you learned in like half an hour.`)}}),y.superMegaBlastLearning&&h({"Let me try the hat!":()=>{t()<2?k("No!"):k("OK.")}}),w(y.exitText)}},Game.merrick={name:"frat scientist",exitText:"Uh, carry on I guess",desc:()=>{d("merrick")?k(`
      ...
      `]),a("Merrick"),h({"What are you mixing?":()=>{k(`
        ...
        `),h({"Let me try it":()=>{k(`
          ...
          `),h({"Blarrf!":()=>{k(`
            ...
            `)}}),h({"Huuurggg!":()=>{k('"Not perfect yet," mumbled Merrick. "Needs more absinthe and strychnine."')}}),h({"Excuse me. Can you direct me to the nearest bipedal-friendly porcelain commode?":()=>{k(`Merrick slowly transforms into an enormous Kafkaesque toilet. "What did you
        ...
        `})}}),w(y.exitText)}},Game.rebnah={exitText:"Nice chatting with you",hasTheToken:!1,location:"cityEntrance",name:"greeter hologram",talkLabel:()=>{var[e,,t,,]=n("rebnah");return`Chat with ${t} `+e},notMet:()=>{return`
      ...
      `},desc:()=>`
        ...
        Rebnah the greeter hologram waves to you cheerily, which is impressive considering her vast quantity of arms. ${T(25)?`She 
              emits a thunderous snort and rubs her fantastic nose.`:""}
              
    `,talk:()=>{y.hasTheToken=!0,k([`
      ...
      `]),a("Rebnah"),h({"Tell me about your home planet":()=>{k([`
    ...
    `}),y.hasTheToken&&e({"Read the token":`
          ...
          `}),w("See you later")},afterShipDestroyed:()=>{k(`
              
    Rebnah the greeter hologram offers a wan smile, seemingly aware that you're having a rough day.
    
    `),h({"Do you just pop in and out of existence like that all the time?":()=>{y.exitText="Well, it's been a... pleasure, I guess",k(`
      ...
      `),h({"That's... horrific...":`
          ...
          `})}}),w(y.exitText)}},Game.spaceKing={preventWar:!1,name:"man",talk:()=>{a("Space King"),k([`
      ...
      `]),e({"Never heard of you":`
        ...
        `),e({"What's the most impressive thing you've ever done?":()=>{k(`
        ...
        `),h({"Did you have the moral right to create a living thing?":()=>{k(`
          
          "I don't know," responded the Space King, "But, I do know this: he was delicious."
          
          `)}}),h({"What kind of pie was it?":()=>{k(`
      ...
      `}),e({"What are you doing *here* of all places?":()=>{y.preventWar=!0,k(`
      ...
      `})}}),w("A pleasure to talk to you, oh Space King")}},Game.yates={askedAboutName:!1,talk:()=>{y.askedAboutName;k(`
        ...
        `),h({"Tell me again why your name is Yates":()=>{y.askedAboutName=!0,k(`
        ...
        `)}}),h({"Will you hurry up already?":()=>{f("yates","annoyed"),k(`"I'm working as fast as I can," he grumbled.`)}}),w("Well, keep working, we've got to get off this rock",()=>{k("Yates nods and buries himself in repair work. A shadow of paranoia crosses your mind that he may not know what he's doing.")})},annoyed:()=>{k(`
    ...
    `}),h({"Thank you for working so hard, Yates":()=>{f("yates","talk"),k(`
        
        "Thanks. I'm going as fast as I can."
        
        `)}}),w("Well, keep working, we've got to get off this rock")}},Game.city=()=>{k(`
    ...
    `),T(75)&&k(S(["Boom! Boom! Boom! The base from the micro-sized festival echoes down the street.",`You can hear what sounds like tiny screams from the festival ahead. Either people are
    ...
    `}),h({"Find the repair shop":p("shipRepairShop")}),h({"Enter the library":p("library")}),h({"Walk to the festival":()=>{k(`Your skin tingles a bit as you pass through a compression field and
      are shrunk to a couple of millimeters tall
      so as to enter the venue.`),h({"Hey that tickles":p("festival")})}}),h({"Leave the village":p("cityEntrance")})},Game.cityEntrance=()=>{k(`
    ...
    `),T(50)&&k(S(["A door quietly shuts somewhere beyond the wall.","The wind whips just enough around the walls to produce a low, sad whistle."])),e({"Read the 1000 meter tall sign":`
    The writing is small, you'll have to get closer by heading towards the lake.
  `}),h({"Head up the hill":p("outsideShip")}),h({"Follow the path to the lake":p("lakeSide")}),h({"Enter the village":p("city")})},Game.festival=()=>{k(`
    ...
    `),c("merrick"),T(50)&&k(S(["An explosion of confetti fills the air, with several colored bits landing on your face.","The crowd cheers, as though someone either drank another flight or passed out."])),h({"Talk to {the} {name}":b("merrick")}),h({"Dance with the crowd":`
  ...
  `}),h({"Listen to the music":`
    ...
    It's tough to hear any lyrics, but it sounds like the ${S([`3rd Movement of Parnassor the Tuneless Suicidal on the Great Ending of Everything Ever.
  ...
  `}),h({"Leave the festival":p("city")})},Game.lakeSide=()=>{var[e,t,a]=n("spaceKing"),o={};o[u("spaceKing")]=b("spaceKing"),k(`
  ...
  `),T(50)&&k(S(["The wind creates soft little ripples over the lake.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),h({"Read the incredible sign":`
  ...
  `}),h(o),h({"Climb back up towards the village":p("cityEntrance")}),h({"Enter the swamp":p("nearSwamp")})},Game.library=()=>{k(`
    ...
    `}),h({"Exit the library":p("city")})},Game.nearSwamp=()=>{k(`
      ...
      `),T(50)&&k(S(["A particularly large bubble pops, filling the air with stench.","A loud POP carries over the water as another bubble explodes."])),h({"Head towards the cave":p("cave")}),h({"Go to the clean part of the lake":p("lakeSide")})},Game.myShip={stillHere:!0},Game.cockpit=()=>{k(`
    ...
    `),h({"Climb down to the Main Deck":p("mainDeck")}),h({"Sit in the chair":"You sit in the command chair and feel very heroic."}),h({"Look out the window":"The purple sky and distant golden mountains don't resemble any planet you've visited before."})},Game.mainDeck=()=>{k(`
    ...
    `),h({"Go to the cockpit":p("cockpit")}),h({"Exit the ship":p("outsideShip")})},Game.outsideShip=()=>{m.myShip.stillHere?(k(`
    ...
    `),T(50)&&k(S(["A big pink cloud poofs on by over the horizon.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),h({"Hey, Yates":b("yates")}),h({"Admire my ship":`
    ...
    this morning's landing not withstanding. Currently, Yates ${S(["has coolant spilled all over the hull","is tightening bolts on a rusted structural support","is pulling a fuel hose from under the engine"])}.
    
    `}),h({"Enter the ship":p("mainDeck")})):k(`
    ...
    `),h({"Go down to the village":p("cityEntrance")})},Game.shipRepairShop=()=>{k(`
  ...
  `}),h({"Return to the village":p("city")})},Game.start=()=>{k(`

    # We Might All Die on Snorlag
    
    ## A game by spaceflounder
    
    `),h({Start:p("intro1")})},Game.intro1=()=>{k(`
    ...
    `),h({"Ugghh... It's too early for an emergency...":p("intro2")})},Game.intro2=()=>{k(`
    ...
    `),h({"Yates! What happened?":p("intro3")})},Game.intro3=()=>{k(`
    ...
    `),h({"Did you say two weeks?":p("outsideShip")})};const s=(e,t=!1)=>{const a=t?"div":"p";return e.split("\n").map(e=>e.trim()).join("\n").split("\n\n").filter(e=>""!==e).map(e=>`<${a}>${(o=>{const n={quote:!0,bold:!0,italic:!0};var e=(e,t,a)=>{for(;-1<o.indexOf(e);)o=n[t]?o.replace(e,`<${a}>`):o.replace(e,`</${a}>`),n[t]=!n[t]},t=(t,a)=>o=o.split("\n").map(e=>0===e.trimStart().indexOf(t)?`<${a}>${e.replace(t,"")}</${a}>`:e).join("\n");return t("#### ","h4"),t("### ","h3"),t("## ","h2"),t("# ","h1"),e('"',"quote","q"),e("**","bold","b"),e("*","italic","i"),o=o.trim()})(e)}</${a}>`).join("")};let r=!1;let l=0;const e=(e,t)=>{let a=Object.keys(e)[0];const o="d"+function(){var e=0;if(0!=a.length)for(i=0;i<a.length;i++)e=(e<<5)-e+(char=a.charCodeAt(i)),e&=e;return e}();var n;m[o]||((n={})[a]=()=>{m[o]=!0,"function"==typeof e[a]?e[a]():k(e[a])},h(n,t))},h=(e,t)=>{var a=document.getElementById("btns");let o="",n=null;"object"==typeof e&&(o=Object.keys(e)[0],n=e[o]),a&&o&&n&&(l+=1,o=o.trim(),(e=document.createElement("button")).onclick=()=>{var e,t=document.getElementsByClassName("main")[0].innerHTML,a=(v(),backButtonHidden=!0,r=o,m.isTalking&&(a=y?.state??"talk",e=y[a]["btn-"+o]??0,y[a]["btn-"+o]=e+1),document.createElement("div"));a.className="outPage",a.innerHTML=t,document.body.appendChild(a),setTimeout(()=>{document.getElementsByClassName("outPage")[0].remove();var e=document.createElement("div"),t=(e.className="main",document.createElement("div")),a=(t.className="page",t.id="page",document.createElement("btns"));a.className="btns",a.id="btns",document.body.appendChild(e),e.appendChild(t),e.appendChild(a),"function"==typeof n?n():k(n),!(backButtonHidden=0===l?!1:backButtonHidden)&&g&&h({"➜":()=>{g&&g()}})},490)},e.className="button",e.innerHTML=`<div class='buttonText'>${s(o,!0)}</div>`,t?a.prepend(e):a.appendChild(e))},o=e=>e[0].toUpperCase()+e.slice(1),t=(e,t,a)=>{return e=e||r,t=t||m.isTalking,a=a||(y.state??"talk"),m[t][a]["btn-"+e]??0},n=e=>{e=e||m.isTalking;var t=m[e].a??"a",a=m[e].the??"the",o=m[e].that??"that";return[m[e].name??"person",t,a,o]},a=(e,t)=>{t=t||m.isTalking,m[t].a="",m[t].the="",m[t].that="",m[t].name=e},d=e=>(e=e||m.isTalking,m[e].hasMet),u=e=>{e=e||m.isTalking;var[t,,a,,]=n(e);return m[e].talkLabel?"string"==typeof m[e].talkLabel?m[e].talkLabel:m[e].talkLabel():`Talk to ${a} `+t},c=e=>{if(e=e||m.isTalking,!d(e)&&m[e].notMet)return"function"==typeof m[e].notMet?m[e].notMet():m[e].notMet??o(`${a} ${t} is here.`);if("function"==typeof m[e].desc)return m[e].desc();const[t,,a]=n(e);return m[e].desc??o(`${a} ${t} is here.`)};let m={};let y={},g=()=>{};const p=t=>{return()=>{m.currentLocationName=t;var e=()=>{m[t](),Object.keys(m).map(e=>{var t;m[e].location&&m.currentLocationName===m[e].location&&(t=c(e),k(t),m[e].talk)&&((t={})[u(e)]=b(e),h(t,!0))})};e(),g=e}},f=(e,t)=>{t=t??"talk";m[e].state=t,m.isTalking===e&&(g=m[e][t])},b=t=>()=>{m.isTalking=t,(y=m[t]).hasMet=!0;var e=y?.state??"talk";backButtonHidden=!0,m[t][e](),g=m[t][e]},w=(e,t)=>{var a={};a[e]=()=>{t?(t(),h({"➜":()=>{p(m.currentLocationName)(),m.isTalking=""}})):(p(m.currentLocationName)(),m.isTalking="")},h(a)},v=()=>{document.getElementsByClassName("main")[0].remove(),window.scrollTo(0,0),l=0},k=e=>{if(Array.isArray(e)){var t=e;const n=t[0];var a="i"+(()=>{let e=0;if(0!=n.length)for(i=0;i<n.length;i++){var t=n.charCodeAt(i);e=(e<<5)-e+t,e&=e}return e})(),o=m[a]??0;o?(k(t[o]),o<t.length-1&&(m[a]=o+1)):(m[a]=1,k(n))}else"string"==typeof e?document.getElementById("page").innerHTML+=s(e):"function"==typeof e&&(document.getElementById("page").innerHTML+=s(e()))},T=e=>e>=Math.floor(100*Math.random());const S=e=>{return(e=>{let t=e.length,a;for(;0!=t;)a=Math.floor(Math.random()*t),t--,[e[t],e[a]]=[e[a],e[t]];return e})([...e])[0]};window.addEventListener("load",()=>{m={...Game},p("start")()});