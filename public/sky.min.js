Game.rebnah={hasTheToken:!1,name:"greeter hologram",exitText:"Nice chatting with you",desc:()=>{var e;t("rebnah")?w(`
    ...
    `),s("Do you just pop in and out of existence like that all the time?",()=>{h.exitText="Well, it's been a... pleasure, I guess",w(`
      ...
      `)}),g(h.exitText)}},Game.spaceKing={preventWar:!1,name:"man",_:()=>{e("Space King"),f(`
        ...
        `)}),s("Will you hurry up already?",()=>{c("yates","annoyed"),w(`"I'm working as fast as I can," he grumbled.`)}),g("Well, keep working, we've got to get off this rock")},annoyed:()=>{w(`
      ...
      `),s("Thank you for working so hard, Yates",()=>{c("yates","_"),w(`
        
        "Thanks. I'm going as fast as I can."
        
        `)}),g("Well, keep working, we've got to get off this rock")}},Game.cityEntrance=()=>{var[e,,t,,]=r("rebnah");w(`
    ...
    `),o("rebnah"),v(50)&&w(b(["A door quietly shuts somewhere beyond the wall.","The wind whips just enough around the walls to produce a low, sad whistle."])),s(`Chat with ${t} `+e,()=>y("rebnah")),a("Read the 1000 meter tall sign","The writing is small, you'll have to get closer by heading towards the lake."),s("Head up the hill",()=>m("outsideShip")),s("Follow the path to the lake",()=>m("lakeSide")),s("Enter the village",()=>m("city"))},Game.lakeSide=()=>{var[e,t,a]=r("spaceKing");w(`
    ...
    `),v(50)&&w(b(["The wind creates soft little ripples over the lake.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),s("Read the incredible sign",`
  ...
  **Here He Is**
  ...
  `),s(`Speak to ${a} `+e,()=>y("spaceKing")),s("Climb back up towards the village",()=>m("cityEntrance")),s("Enter the swamp",()=>m("nearSwamp"))},Game.myShip={stillHere:!0},Game.cockpit=()=>{w(`
    ...
    `),s("Climb down to the Main Deck",()=>m("mainDeck")),s("Sit in the chair","You sit in the command chair and feel very heroic."),s("Look out the window","The purple sky and distant golden mountains don't resemble any planet you've visited before.")},Game.mainDeck=()=>{w(`
    ...
    `),s("Go to the cockpit",()=>m("cockpit")),s("Exit the ship",()=>m("outsideShip"))},Game.outsideShip=()=>{l.myShip.stillHere?(w(`
    ...
    `),v(50)&&w(b(["A big pink cloud poofs on by over the horizon.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),s("Hey, Yates",()=>y("yates")),s("Admire my ship",`
    ...
    this morning's landing not withstanding. Currently, Yates ${b(["has coolant spilled all over the hull","is tightening bolts on a rusted structural support","pulling a fuel hose from under the engine"])}.
    
    `),s("Enter the ship",()=>m("mainDeck"))):w(`
    ...
    `),s("Go down to the village",()=>m("cityEntrance"))},Game.start=()=>{w(`

    # We Might All Die on Snorlag
    
    ## A game by spaceflounder
    
    `),s("Start",()=>m("intro1"))},Game.intro1=()=>{w(`
    ...
    `),s("Ugghh... It's too early for an emergency...",()=>m("intro2"))},Game.intro2=()=>{w(`
    ...
    `),s("Yates! What happened?",()=>m("intro3"))};let n=!(Game.intro3=()=>{w(`
    ...
    `),s("Did you say two weeks?",()=>m("outsideShip"))});const a=(t,e)=>{const a="d"+function(){var e=0;if(0!=t.length)for(i=0;i<t.length;i++)e=(e<<5)-e+(char=t.charCodeAt(i)),e&=e;return e}();l[a]||s(t,()=>{l[a]=!0,w(e)})},s=(e,t)=>{var a,o=document.getElementById("card");o&&e&&t&&(e=e.trim(),(a=document.createElement("button")).onclick=()=>{p(),n=!0,window.scrollTo(0,0),w(t),!(n=""===document.getElementById("card").innerHTML?!1:n)&&d&&s("✔",()=>{d&&d()})},a.className="button",a.innerHTML=`<div class='buttonText'>${k(e,!0)}</div>`,o.appendChild(a))},r=e=>{e=e||l.isTalking;var t=l[e].a??"a",a=l[e].the??"the",o=l[e].that??"that";return[l[e].name??"man",t,a,o]},e=(e,t)=>{t=t||l.isTalking,l[t].a="",l[t].the="",l[t].that="",l[t].name=e},t=e=>(e=e||l.isTalking,l[e].hasMet),o=e=>{var t,a,o;return e=e||l.isTalking,"function"==typeof l[e].desc?l[e].desc():([t,a,o]=r(e),l[e].desc??(e=o+` ${t} is here.`)[0].toUpperCase()+e.slice(1))};let l={},h={},d=()=>{},u="";const m=e=>{n=!0,u=e,l[e](),d=l[e]},c=(e,t)=>{t=t??"_";l[e].state=t,l.isTalking===e&&(d=l[e][t])},y=e=>{l.isTalking=e,(h=l[e]).hasMet=!0;var t=h?.state??"_";n=!0,l[e][t](),d=l[e][t]},g=e=>s(e,()=>{m(u),l.isTalking=""}),p=()=>{document.getElementById("page").innerHTML="",document.getElementById("card").innerHTML=""},f=(t,e)=>{var a="i"+function(){var e=0;if(0!=t.length)for(i=0;i<t.length;i++)e=(e<<5)-e+(char=t.charCodeAt(i)),e&=e;return e}();l[a]?w(e):(l[a]=!0,w(t))},w=e=>{"string"==typeof e?document.getElementById("page").innerHTML+=k(e):"function"==typeof e&&e()},v=e=>e>=Math.floor(100*Math.random());const b=e=>{return(e=>{let t=e.length,a;for(;0!=t;)a=Math.floor(Math.random()*t),t--,[e[t],e[a]]=[e[a],e[t]];return e})([...e])[0]},k=(e,t=!1)=>{const a=t?"div":"p";return e.split("\n").map(e=>e.trim()).join("\n").split("\n\n").filter(e=>""!==e).map(e=>`<${a}>${(o=>{const i={quote:!0,bold:!0,italic:!0};var e=(e,t,a)=>{for(;-1<o.indexOf(e);)o=i[t]?o.replace(e,`<${a}>`):o.replace(e,`</${a}>`),i[t]=!i[t]},t=(t,a)=>o=o.split("\n").map(e=>0===e.trimStart().indexOf(t)?`<${a}>${e.replace(t,"")}</${a}>`:e).join("\n");return t("#### ","h4"),t("### ","h3"),t("## ","h2"),t("# ","h1"),e('"',"quote","q"),e("**","bold","b"),e("*","italic","i"),o=o.trim()})(e)}</${a}>`).join("")};window.addEventListener("load",()=>{l={...Game},m("start")}),Game.nearSwamp=()=>{var[e,,t,,]=r("loon"),a=l.loon.location===u;w(`
      ...
      `),a&&o("loon"),v(50)&&w(b(["A particularly large bubble pops, filling the air with stench.","A loud POP carries over the water as another bubble explodes."])),a&&s(`Talk to ${t} `+e,()=>y("loon")),s("Head towards the cave",()=>m("cave")),s("Go to the clean part of the lake",()=>m("lakeSide"))},Game.loon={name:"green man",location:"nearSwamp",exitText:"Nice chatting with you",desc:()=>{t("loon")?w(`
    ...
    `),g("Have a good day scooping mud")}},Game.merrick={name:"frat scientist",location:"festival",exitText:"Uh, carry on I guess",desc:()=>{t("merrick")?w(`
      ...
      `),e("Merrick"),s("What are you mixing?",()=>{w(`
        ...
        `)}),g(h.exitText)}},Game.festival=()=>{var[e,,t,,]=r("merrick");w(`
    ...
    `),o("merrick"),v(50)&&w(b(["An explosion of confetti fills the air, with several colored bits landing on your face.","The crowd cheers, as though someone either drank another flight or passed out."])),s(`Talk to ${t} `+e,()=>y("merrick")),s("Dance with the crowd","OOF! OUCH! HMPH! Arms, legs and tentacles flail around you as you attempt to cut a rug."),s("Listen to the music","It's tough to hear any lyrics, but it sounds like the "+b([`3rd Movement of Parnassor the Tuneless Suicidal on the Great Ending of Everything Ever.
        ...
        wrote only polkas.`])),s("Leave the festival",()=>m("city"))},Game.city=()=>{w(`
    ...
    `),v(75)&&w(b(["Boom! Boom! Boom! The base from the micro-sized festival echoes down the street.",`You can hear what sounds like tiny screams from the festival ahead. Either people are
    ...
    `),s("Walk to the festival",()=>{w(`Your skin tingles a bit as you pass through a compression field and are shrunk to a couple of millimeters tall
      so as to enter the venue.`),s("Hey that tickles",()=>m("festival"))}),s("Leave the village",()=>m("cityEntrance"))};
