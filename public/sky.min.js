let n=!1;const t=()=>{if(!n){const a=document.createElement("div"),o=(a.className="menu",document.createElement("div"));o.style=`
  ...
  `,desc:{talk:"Professor Loon is still here, gathering more sludge into tubes. ",annoyed:"Professor Loon is in mud, looking very annoyed about something"},talk:()=>{I([`
    ...
    `]),y("Loon"),e("Just in time for what?",()=>{I(`
      ...
      `)}),a("Just in")&&u("You really can't even give me a tiny hint what you're working on?",()=>{I([`
    ...
    `),u("Hey, can I see that crank for a second?",()=>{I(`
        ...
        `)}),p("merrick")&&a("Just in")&&u("You know, that Merrick guy at the festival seems like quite a scientist himself",()=>{I(`
          
          Loon snorts. "I can assure you, my friend, Merrick is *no* scientist of any sort."
          
          `),u("I don't know. He seems on the edge of a breakthrough!",()=>{I(`
            ...
            `),f(""),w("annoyed"),k("Well OK then")}),u("If you say so",`
    ...
    `,talk:()=>{y("Mavis"),I([`
        ...
        `]),u("Why haven't you got any books?",()=>{s.bookAskCount<2&&(s.bookAskCount+=1),I([`
            ...
            `])}),a("any books")&&u("Are you really a giant brain?",()=>{I(`
            
            "I should hope that should be obvious..." said Mavis with an edge of annoyance.
            "Why do you ask?"
            
            `),u("You must get asked some tough questions",()=>{I(`
                
                "Sure," said Mavis. "Mostly about the Dewey Decimal System. Nobody
                understands the Dewey Decimal System."
                
                `),u("So what's the hardest question you've ever been asked?",()=>{I('"Once," said Mavis, "A snotty 10 year-old Zogtarian came in and asked me a riddle.'),u("Was it what's the difference between a coffee mug and a doughnut?",`
                    
                    Mavis grumbled: "No, he was a Zogtarian, not a Topzoidian."
                    
                    `),u("Was it about how to create a fat-free Mayonnaise-replacement product that delivers on value and flavor?",`
                    
                    "Of course not. We'd already invented Hidden Valley dressing at that point."
                    
                    `),u("What was it?",()=>{I('"Only this," said Mavis with a serious tone, "Why is a raven like a writing desk?"'),u("That's it?",()=>{E("writingDesk",!0),I(`

                        Mavis chuckled. "Oh sure, it seems simple. But it even stumped the Old Man in the Cave."
                        
                        `)})})}),u("Do you understand the Dewey Decimal System?",`
                
                "Erm... Of course I do," Mavis stammered. "Don't you have something better to do then bug me?"
                
                `)}),u("Oh, I just had to ask to be sure.",`
      ...
      `]),y("Merrick"),u("Are you working the bar all by yourself?",`
      ...
      `),u("What are you mixing?",()=>{I(`
        ...
        `),u("Let me try it",()=>{I(`
          ...
          `),u("Blarrf!",()=>{I(`
            ...
            `)}),u("Huuurggg!",()=>{I('"Not perfect yet," mumbled Merrick. "Needs more absinthe and strychnine."')}),u("Excuse me. Can you direct me to the nearest bipedal-friendly porcelain commode?",()=>{I(`Merrick slowly transforms into an enormous Kafkaesque toilet. "What did you
        ...
        `)}),k(s.exitText)}},Game.rebnah={exitText:"Nice chatting with you",hasTheToken:!1,location:"cityEntrance",name:"greeter hologram",talkLabel:()=>{var[e,,t,,]=m("rebnah");return`Chat with ${t} `+e},notMet:()=>{return`
    ...
    `,talk:()=>{s.hasTheToken=!0,I([`
      ...
      `]),y("Rebnah"),u("Tell me about your home planet",()=>{I([`
    ...
    `),u("Do you just pop in and out of existence like that all the time?",()=>{s.exitText="Well, it's been a... pleasure, I guess",I(`
  ...
  `,talk:()=>{y("Space King"),I([`
      ...
      `),e("What's the most impressive thing you've ever done?",()=>{I(`
        ...
        `),u("Did you have the moral right to create a living thing?",()=>{I(`
          
          "I don't know," responded the Space King, "But, I do know this: he was delicious."
          
          `)}),u("What kind of pie was it?",()=>{I(`
  ...
  `,talk:()=>{I(`
        ...
        `),u("Tell me again why your name is Yates",()=>{I(`
        ...
        `)}),k("Well, keep working, we've got to get off this rock",()=>{I("Yates nods and buries himself in repair work. A shade of anxiety crosses your mind that he may not know what he's doing.")})},annoyed:()=>{I(`
    ...
    `),u("Thank you for working so hard, Yates",()=>{w(),I(`
    ...
    `),u("Enter the cave",()=>{L("caveForceFieldOff")?S("insideCave")():I(`
            ...
            `)}),u("Return to the swamp",S("nearSwamp"))},Game.city=()=>{I(`
    ...
    `),u("Find the repair shop",S("shipRepairShop")),u("Enter the library",S("library")),u("Walk to the festival",()=>{I(`Your skin tingles a bit as you pass through a compression field and
      are shrunk to a couple of millimeters tall
      so as to enter the venue.`),u("Hey that tickles",S("festival"))}),u("Leave the village",S("cityEntrance"))},Game.cityEntrance=()=>{I(`
  ...
  `),u("Head up the hill",S("outsideShip")),u("Follow the path to the lake",S("lakeSide")),u("Enter the village",S("city"))},Game.festival=()=>{I(`
    ...
    `),T(()=>M(25)&&x(["An explosion of confetti fills the air, with several colored bits landing on your face.","The crowd cheers, as though someone either drank another flight or passed out."])),u("Dance with the crowd",`
  ...
  `),u("Leave the festival",S("city"))},Game.lakeSide=()=>{var[e,,t]=m("spaceKing");I(`
  ...
  `),T(()=>M(25)&&x(["The wind creates soft little ripples over the lake.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),u("Read the incredible sign",`
  ...
  `),u("Climb back up towards the village",S("cityEntrance")),u("Enter the swamp",S("nearSwamp"))},Game.library=()=>{I(`
    ...
    `),u("Exit the library",S("city"))},Game.nearSwamp=()=>{I(`
      ...
      `),u("Turn crank",()=>{E("caveForceFieldOff",!0),I(`
        
          The force field control is now in the off position.
        
          `)})),T(()=>M(25)&&x(["A particularly large bubble pops, filling the air with stench.","A loud POP carries over the water as another bubble explodes."])),u("Head towards the cave",S("caveMouth",()=>{L("caveForceFieldOff")&&f("nearSwamp",loon)})),u("Go to the clean part of the lake",S("lakeSide",()=>{L("caveForceFieldOff")&&f("nearSwamp",loon)}))},Game.myShip={stillHere:!0},Game.cockpit=()=>{I(`
  ...
  `),u("Climb down to the Main Deck",S("mainDeck"))},Game.mainDeck=()=>{I(`
    ...
    `),u("Go to the cockpit",S("cockpit")),u("Exit the ship",S("outsideShip"))},Game.outsideShip=()=>{I(`
    ...
    `),v()&&M(50)&&I(x(["A big pink cloud poofs on by over the horizon.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),u("Admire the view",`
    ...
    `),u("Enter the ship",S("mainDeck")),u("Go down to the village",S("cityEntrance"))},Game.shipRepairShop=()=>{I(`
  ...
  `),u("Return to the village",S("city"))},Game.start=()=>{I(`
    ...
    `),u("Start",S("intro1"))},Game.intro1=()=>{I(`
    ...
    `),u("Ugghh... It's too early for an emergency...",S("intro2"))},Game.intro2=()=>{I(`
    ...
    `),u("Yates! What happened?",S("intro3"))},Game.intro3=()=>{I(`
    ...
    `),u("Did you say two weeks?",S("outsideShip"))},window.addEventListener("load",()=>{var e;r={...Game},(e=document.createElement("div")).className="topBar",e.onclick=t,document.body.appendChild(e),d(),S("outsideShip")()});const e=e=>{const t=Object.keys(e).filter(e=>-1===reserved.indexOf(e))[0],a="d"+o(t);r[a]||u(t,()=>{r[a]=!0,"function"==typeof e[t]?e[t]():I(e[t])})},h=()=>{document.getElementsByClassName("main")[0].remove(),r.buttonCount=0},d=()=>{let e=document.getElementsByClassName("topRoot")[0];var t=document.createElement("div"),a=document.createElement("div"),o=document.createElement("btns");e||((e=document.createElement("div")).className="topRoot",document.body.appendChild(e)),e.appendChild(t),t.className="main",t.id="main",a.className="page",a.id="page",o.className="btns",o.id="btns",e.appendChild(t),t.appendChild(a),t.appendChild(o)},u=(o,n,e)=>{var t=document.getElementById("btns");if(!(t&&o&&n))throw"Button could not be constructed! With options: "+o;r.buttonCount||(r.buttonCount=0),r.buttonCount+=1,o=o.trim();var a=document.createElement("button");a.type="button",a.onclick=()=>{var e=document.getElementsByClassName("main")[0].innerHTML,t=(h(),r.isTalking&&(t=s?.state??"talk",a=s[t]["btn-"+o]??0,r.lastButtonPressed=o,s[t]["btn-"+o]=a+1),document.createElement("div")),a=(t.className="outPage",t.id="outPage",t.innerHTML=e,document.getElementsByClassName("topRoot")[0]);a&&a.appendChild(t),setTimeout(()=>{document.getElementById("outPage").remove(),window.scrollTo(0,0),d(),"function"==typeof n?n():I(n),!r.env||!r.isTalking&&r.buttonCount||I(r.env()),!r.buttonCount&&r.lastNode&&u("➜",()=>{r.lastNode&&r.lastNode()})},450)},a.className="button",a.innerHTML=`<div class='buttonText'>${l(o,!0)}</div>`,e?t.prepend(a):t.appendChild(a)},c=e=>e[0].toUpperCase()+e.slice(1);const a=(o,t,e)=>{t=t||r.isTalking;var a=e=>{for(const t of e)if(Array.isArray(o)){for(const a of o)if(-1<t.indexOf(a))return!0}else if(-1<t.indexOf(o))return!0;return!1};if("*"!==(e=e||"*"))return a(Object.keys(r[t][e]).filter(e=>"function"==typeof e).filter(e=>-1<e.indexOf("btn-")));for(const n of Object.keys(r[t]))if(a(Object.keys(r[t][n]).filter(e=>"number"==typeof r[t][n][e]).filter(e=>-1<e.indexOf("btn-"))))return!0;return!1},m=e=>(e=e||r.isTalking,p(e)?[r[e].name,"","",""]:[r[e].name,"a","the","that"]),y=(e,t)=>{t=t||r.isTalking,r[t].name=e},p=e=>(e=e||r.isTalking,r[e].hasMet),g=e=>{return(e?r[e]:s).location},f=(e,t)=>{(t?r[t]:s).location=e},w=(e,t)=>{e=e??"talk";t=t||r.isTalking,r[t].state=e,r.isTalking===t&&(r.lastNode=r[t][e])},v=e=>{return e=e||r.currentLocationName,r[e].visited??0},b=e=>{e=e||r.isTalking,r.map||(r.map=[]),r[e]&&r[e].location&&-1===r.map.indexOf(e)&&r.map.push(e)},k=(e,t)=>{var a={};a[e]=()=>{t?(t(),u("➜",()=>{S(r.currentLocationName)(),r.isTalking=""})):(S(r.currentLocationName)(),r.isTalking="")},u(a)},T=e=>{r.env=e},I=e=>{var t=document.getElementById("page");if(t)if(Array.isArray(e)){var a=e;const s=a[0];var o="i"+(()=>{let e=0;if(0!=s.length)for(i=0;i<s.length;i++){var t=s.charCodeAt(i);e=(e<<5)-e+t,e&=e}return e})(),n=r[o]??0;n?(I(a[n]),n<a.length-1&&(r[o]=n+1)):(r[o]=1,I(s))}else"string"==typeof e?t.innerHTML+=l(e):"function"==typeof e&&(t.innerHTML+=l(e()))},S=t=>{const a=()=>{Object.keys(r).map(e=>{var t,a;r[e]?.location&&r.currentLocationName===r[e]?.location&&(t=(e=>{e=e||r.isTalking;var[t,,a]=m(e),o=r[e].state??"talk";if(!p(e)&&r[e].notMet){if("function"==typeof r[e].notMet)return r[e].notMet();if("object"==typeof r[e].notMet&&r[e].notMet[o]){if("function"==typeof r[e].notMet[o])return r[e].notMet[o]();if("string"==typeof r[e].notMet[o])return r[e].notMet[o]}return r[e].notMet??c(a+` ${t} is here.`)}if("function"==typeof r[e].desc)return r[e].desc();if("object"==typeof r[e].desc&&r[e].desc[o]){if("function"==typeof r[e].desc[o])return r[e].desc[o]();if("string"==typeof r[e].desc[o])return r[e].desc[o]}return r[e].desc??c(a+` ${t} is here.`)})(e),I(t),r[e].talk)&&u((e=>{e=e||r.isTalking;var[t,,a,,]=m(e);return r[e].talkLabel?"string"==typeof r[e].talkLabel?r[e].talkLabel:r[e].talkLabel():`Talk to ${a} `+t})(e),(a=e,()=>{r.isTalking=a,(s=r[a]).hasMet=!0;var e=s?.state??"talk";b(),1!==r?.map?.length||r.showFastTravelTip||(r.showFastTravelTip=1),r[a][e](),r.lastNode=r[a][e]}),!0)})};return()=>{r.currentLocationName=t;var e=()=>{var e=r[t]?.visited??0;r.env=null,r.isTalking="",r[t](),a(),r[t].visited=e+1,1===r.showFastTravelTip&&r[r.map[0]].location!==r.currentLocationName&&(r.showFastTravelTip=2,A("Hey there! You can now fast travel to characters you meet by tapping the top ⤴ of the screen"))};e(),r.lastNode=e}},M=e=>e>=Math.floor(100*Math.random());const x=e=>{var t=`p{${o(e.join("-"))}}`;return r[t]&&r[t]?.length||(r[t]=(e=>{let t=e.length,a;for(;0!=t;)a=Math.floor(Math.random()*t),t--,[e[t],e[a]]=[e[a],e[t]];return e})([...e])),r[t].pop()},A=e=>{const t=document.createElement("div");t.className="tipBox",t.id="tipBox";var a=document.createElement("div"),o=(a.className="tipInnerBox",a.id="tipInnerBox",document.createElement("div"));o.className="tipInnerText",o.id="tipInnerText",o.innerText=e,a.appendChild(o),t.appendChild(a),t.onclick=()=>t.remove(),document.body.appendChild(t)},L=e=>(r.values||(r.values={}),r.values[e]??!1),E=(e,t)=>{r.values||(r.values={}),r.values[e]=t};