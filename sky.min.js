let n=!1;const t=()=>{if(!n){const a=document.createElement("div"),o=(a.className="menu",document.createElement("div"));o.style=`
    ...
    `}),c({"Hey, can I see that crank for a second?":()=>{I(`
        ...
        `})}}),p("merrick")&&a("Just in")&&c({"You know, that Merrick guy at the festival seems like quite a scientist himself":()=>{I(`
          ...
          `),c({"I don't know. He seems on the edge of a breakthrough!":()=>{I(`
            ...
            `),f(""),v("annoyed"),k("Well OK then")}}),c({"If you say so":`
  ...
  `,talk:()=>{I(`
        ...
        `)}}),c({"Will you hurry up already?":()=>{v("annoyed"),I(`"I'm working as fast as I can," he grumbled.`)}}),k("Well, keep working, we've got to get off this rock",()=>{I("Yates nods and buries himself in repair work. A shade of anxiety crosses your mind that he may not know what he's doing.")})},annoyed:()=>{I(`
    ...
    `}),c({"Thank you for working so hard, Yates":()=>{v(),I(`
  ...
  `}),c({"Climb back up towards the village":S("cityEntrance")}),c({"Enter the swamp":S("nearSwamp")})},Game.library=()=>{I(`
    ...
    `),w()&&M(50)&&I(x(["A big pink cloud poofs on by over the horizon.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),c({"Admire the view":`
