let n=!1;const t=()=>{if(!n){const a=document.createElement("div"),o=(a.className="menu",document.createElement("div"));o.style=`
  ...
  `,desc:{talk:"Professor Loon is still here, gathering more sludge into tubes. ",annoyed:"Professor Loon is in mud, looking very annoyed about something"},talk:()=>{S([`
    ...
    `]),o("Loon"),d("Just in time for what?",()=>{S(`
      ...
      `)}),a("Just in")&&m("You really can't even give me a tiny hint what you're working on?",()=>{S([`
    ...
    `),m("Loon is an unusual name, where are you from?",`
    ...
    `),m("Hey, can I see that crank for a second?",()=>{S(`
        ...
        `),m("I don't think you're going to find anything tromping in the mud anyway",`
        ...
        `)}),g("merrick")&&a("Just in")&&m("You know, that Merrick guy at the festival seems like quite a scientist himself",()=>{S(`
          
          Loon snorts. "I can assure you, my friend, Merrick is *no* scientist of any sort."
          
          `),m("I don't know. He seems on the edge of a breakthrough!",()=>{S(`
            ...
            `),w(""),v("annoyed"),T("Well OK then")}),m("If you say so",`
          
          "I'm not worried about competing with that so-called mixologist,"
          said Loon with a chuckle. "We're doing actual science here."
          
          `)}),T("Have a good day scooping mud")},annoyed:()=>{S(`
    
    "I'm not in the mood to chat right now," said Loon with a scowl.
    
    `),T("Alrighty")}},Game.mavis={name:"giant brain in a jar",location:"library",exitText:"Thanks for your help",hasMet:!1,superMegaBlastLearning:!1,bookAskCount:0,notMet:()=>`
    ...
    `,talk:()=>{o("Mavis"),S([`
        ...
        `]),m("Why haven't you got any books?",()=>{s.bookAskCount<2&&(s.bookAskCount+=1),S([`
            ...
            `])}),a("any books")&&m("Are you really a giant brain?",()=>{S(`
            
            "I should hope that should be obvious..." said Mavis with an edge of annoyance.
            "Why do you ask?"
            
            `),m("You must get asked some tough questions",()=>{S(`
                
                "Sure," said Mavis. "Mostly about the Dewey Decimal System. Nobody
                understands the Dewey Decimal System."
                
                `),m("So what's the hardest question you've ever been asked?",()=>{S('"Once," said Mavis, "A snotty 10 year-old Zogtarian came in and asked me a riddle.'),m("Was it what's the difference between a coffee mug and a doughnut?",`
                    
                    Mavis grumbled: "No, he was a Zogtarian, not a Topzoidian."
                    
                    `),m("Was it about how to create a fat-free Mayonnaise-replacement product that delivers on value and flavor?",`
                    
                    "Of course not. We'd already invented Hidden Valley dressing at that point."
                    
                    `),m("What was it?",()=>{S('"Only this," said Mavis with a serious tone, "Why is a raven like a writing desk?"'),m("That's it?",()=>{N("writingDesk",!0),S(`

                        Mavis chuckled. "Oh sure, it seems simple. But it even stumped the Old Man in the Cave."
                        
                        `)})})}),m("Do you understand the Dewey Decimal System?",`
                
                "Erm... Of course I do," Mavis stammered. "Don't you have something better to do then bug me?"
                
                `)}),m("Oh, I just had to ask to be sure.",`
            
            "Your powers of observation have not yet ceased to amaze," said Mavis.
            
            `)}),T(s.exitText)}},Game.merrick={name:"frat scientist",location:"festival",exitText:"Uh, carry on I guess",desc:()=>{g("merrick")?S(`
      ...
      `]),o("Merrick"),m("Are you working the bar all by yourself?",`
      ...
      `),m("What are you mixing?",()=>{S(`
        ...
        `),m("Let me try it",()=>{S(`
          ...
          `),m("Blarrf!",()=>{S(`
            ...
            `)}),m("Huuurggg!",()=>{S('"Not perfect yet," mumbled Merrick. "Needs more absinthe and strychnine."')}),m("Excuse me. Can you direct me to the nearest bipedal-friendly porcelain commode?",()=>{S(`Merrick slowly transforms into an enormous Kafkaesque toilet. "What did you
            say again?" he asked. His seat and lid were acting as a tongue and mouth.`)})}),m("It looks like scummy swamp water",`
        
        "Wow, you're a mixologist as well?" said Merrick, obviously impressed. "Not bad."
        
        `)}),T(s.exitText)}},Game.rebnah={exitText:"Nice chatting with you",hasTheToken:!1,location:"cityEntrance",name:"greeter hologram",talkLabel:()=>{var[e,,t,,]=p("rebnah");return`Chat with ${t} `+e},notMet:()=>{return`
    ...
    `,talk:()=>{s.hasTheToken=!0,S([`
      ...
      `]),o("Rebnah"),m("Tell me about your home planet",()=>{S([`
    ...
    `),s.hasTheToken&&d("Read the token",`
          ...
          `),T("See you later")},afterShipDestroyed:()=>{S(`
              
    Rebnah the greeter hologram offers a wan smile, seemingly aware that you're having a rough day.
    
    `),m("Do you just pop in and out of existence like that all the time?",()=>{s.exitText="Well, it's been a... pleasure, I guess",S(`
      ...
      `),m({"That's... horrific...":`
          ...
          `})}),T(s.exitText)}},Game.spaceKing={preventWar:!1,location:"lakeSide",name:"very impressive man",notMet:`
  ...
  `,talk:()=>{o("Space King"),S([`
      ...
      `),d("What's the most impressive thing you've ever done?",()=>{S(`
      ...
      `),d("What are you doing *here* of all places?",()=>{s.preventWar=!0,S(`
      ...
      `)}),T("A pleasure to talk to you, oh Space King")}},Game.yates={name:"Yates",location:"outsideShip",talkLabel:"Hey, Yates",hasMet:!0,desc:`
  ...
  `,talk:()=>{S(`
        ...
        `),m("Tell me again why your name is Yates",()=>{S(`
    ...
    `),m("Enter the cave",()=>{E("caveForceFieldOff")?M("insideCave")():S(`
            ...
            `)}),m("Return to the swamp",M("nearSwamp"))},Game.city=()=>{S(`
    ...
    `),I(()=>x(25)&&A(["Boom! Boom! Boom! The base from the micro-sized festival echoes down the street.",`You can hear what sounds like tiny screams from the festival ahead. Either people are
      depressed over the end of the universe or they're having a pretty good time.`,"The music peaks from the festival, followed by a small but thunderous cheer."])),m("Read the hastily scrawled sign",`
    ...
    `),m("Find the repair shop",M("shipRepairShop")),m("Enter the library",M("library")),m("Walk to the festival",()=>{S(`Your skin tingles a bit as you pass through a compression field and
      are shrunk to a couple of millimeters tall
      so as to enter the venue.`),m("Hey that tickles",M("festival"))}),m("Leave the village",M("cityEntrance"))},Game.cityEntrance=()=>{S(`
    ...
    `),I(()=>x(25)&&A(["A door quietly shuts somewhere beyond the wall.","The wind whips just enough around the walls to produce a low, sad whistle."])),d("Read the 1000 meter tall sign",`
    The writing is small, you'll have to get closer by heading towards the lake.
  `),m("Head up the hill",M("outsideShip")),m("Follow the path to the lake",M("lakeSide")),m("Enter the village",M("city"))},Game.festival=()=>{S(`
    ...
    `),I(()=>x(25)&&A(["An explosion of confetti fills the air, with several colored bits landing on your face.","The crowd cheers, as though someone either drank another flight or passed out."])),m("Dance with the crowd",`
  ...
  `),m("Listen to the music",`
    
    It's tough to hear any lyrics, but it sounds like the ${A([`3rd Movement of Parnassor the Tuneless Suicidal on the Great Ending of Everything Ever.
  ...
  `),m("Leave the festival",M("city"))},Game.lakeSide=()=>{var[e,,t]=p("spaceKing");S(`
  ...
  `),I(()=>x(25)&&A(["The wind creates soft little ripples over the lake.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),m("Read the incredible sign",`
  ...
  `),m("Climb back up towards the village",M("cityEntrance")),m("Enter the swamp",M("nearSwamp"))},Game.library=()=>{S(`
    ...
    `),m("Exit the library",M("city"))},Game.nearSwamp=()=>{S(`
      ...
      `),m("Turn crank",()=>{N("caveForceFieldOff",!0),S(`
        
          The force field control is now in the off position.
        
          `)})),I(()=>x(25)&&A(["A particularly large bubble pops, filling the air with stench.","A loud POP carries over the water as another bubble explodes."])),m("Head towards the cave",M("caveMouth",()=>{E("caveForceFieldOff")&&w("nearSwamp",loon)})),m("Go to the clean part of the lake",M("lakeSide",()=>{E("caveForceFieldOff")&&w("nearSwamp",loon)}))},Game.myShip={stillHere:!0},Game.cockpit=()=>{S(`
    ...
    `),m("Sit in the chair","You sit in the command chair and feel very heroic."),m("Look out the window",`
  
    The purple sky and distant golden mountains don't resemble any planet you've visited before.
  
  `),m("Climb down to the Main Deck",M("mainDeck"))},Game.mainDeck=()=>{S(`
    ...
    `),m("Go to the cockpit",M("cockpit")),m("Exit the ship",M("outsideShip"))},Game.outsideShip=()=>{S(`
    ...
    `),b()&&x(50)&&S(A(["A big pink cloud poofs on by over the horizon.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),m("Admire the view",`
    ...
    even before this morning's landing. Currently, Yates ${A(["has coolant spilled all over the hull","is tightening bolts on a rusted structural support","is pulling a fuel hose from under the engine"])}.
    
    `),m("Enter the ship",M("mainDeck")),m("Go down to the village",M("cityEntrance"))},Game.shipRepairShop=()=>{S(`
  ...
  `),m("Read the sign on the door",`
      
    <center>*Closed until the universe ends*</center>

  `),m("Enter the repair shop",`
      
    The door is shut and locked tight.
      
  `),m("Return to the village",M("city"))},Game.start=()=>{S(`
    ...
    `),m("Start",M("intro1"))},Game.intro1=()=>{S(`
    ...
    `),m("Ugghh... It's too early for an emergency...",M("intro2"))},Game.intro2=()=>{S(`
    ...
    `),m("Yates! What happened?",M("intro3"))},Game.intro3=()=>{S(`
    ...
    `),m("Did you say two weeks?",M("outsideShip"))},window.addEventListener("load",()=>{var e;r={...Game},(e=document.createElement("div")).className="topBar",e.onclick=t,document.body.appendChild(e),c(),M("outsideShip")()});const d=(e,t)=>{const a="d"+h(e);r[a]||m(e,()=>{r[a]=!0,"function"==typeof t?t():S(t)})},e=e=>{const[t,a]=e.shift(),[o,n]=e.pop(),i="stack-function-"+h(t);s[i]=()=>{"function"==typeof a?a():S(a),e.map(e=>{var[e,t]=e;d(e,t)}),0===e.map(e=>void 0!==r["d"+h(e[0])]).filter(e=>!0!==e).length&&m(o,()=>{v(),"function"==typeof n?n():S(n)})},m(t,()=>{v(i),s[i]()})},u=()=>{document.getElementsByClassName("main")[0].remove(),r.buttonCount=0},c=()=>{let e=document.getElementsByClassName("topRoot")[0];var t=document.createElement("div"),a=document.createElement("div"),o=document.createElement("btns");e||((e=document.createElement("div")).className="topRoot",document.body.appendChild(e)),e.appendChild(t),t.className="main",t.id="main",a.className="page",a.id="page",o.className="btns",o.id="btns",e.appendChild(t),t.appendChild(a),t.appendChild(o)},m=(o,n,e)=>{var t=document.getElementById("btns");if(!(t&&o&&n))throw"Button could not be constructed! With options: "+o;r.buttonCount||(r.buttonCount=0),r.buttonCount+=1,o=o.trim();var a=document.createElement("button");a.type="button",a.onclick=()=>{var e=document.getElementsByClassName("main")[0].innerHTML,t=(u(),r.isTalking&&(t=s?.state??"talk",a=s[t]["btn-"+o]??0,r.lastButtonPressed=o,s[t]["btn-"+o]=a+1),document.createElement("div")),a=(t.className="outPage",t.id="outPage",t.innerHTML=e,document.getElementsByClassName("topRoot")[0]);a&&a.appendChild(t),setTimeout(()=>{document.getElementById("outPage").remove(),window.scrollTo(0,0),c(),"function"==typeof n?n():S(n),!r.env||!r.isTalking&&r.buttonCount||S(r.env()),!r.buttonCount&&r.lastNode&&m("➜",()=>{r.lastNode&&r.lastNode()})},450)},a.className="button",a.innerHTML=`<div class='buttonText'>${l(o,!0)}</div>`,e?t.prepend(a):t.appendChild(a)},y=e=>e[0].toUpperCase()+e.slice(1);const a=(o,t,e)=>{t=t||r.isTalking;var a=e=>{for(const t of e)if(Array.isArray(o)){for(const a of o)if(-1<t.indexOf(a))return!0}else if(-1<t.indexOf(o))return!0;return!1};if("*"!==(e=e||"*"))return a(Object.keys(r[t][e]).filter(e=>"function"==typeof e).filter(e=>-1<e.indexOf("btn-")));for(const n of Object.keys(r[t]))if(a(Object.keys(r[t][n]).filter(e=>"number"==typeof r[t][n][e]).filter(e=>-1<e.indexOf("btn-"))))return!0;return!1},p=e=>(e=e||r.isTalking,g(e)?[r[e].name,"","",""]:[r[e].name,"a","the","that"]),o=(e,t)=>{t=t||r.isTalking,r[t].name=e},g=e=>(e=e||r.isTalking,r[e].hasMet),f=e=>{return(e?r[e]:s).location},w=(e,t)=>{(t?r[t]:s).location=e},v=(e,t)=>{e=e??"talk";t=t||r.isTalking,r[t].state=e,r.isTalking===t&&(r.lastNode=r[t][e])},b=e=>{return e=e||r.currentLocationName,r[e].visited??0},k=e=>{e=e||r.isTalking,r.map||(r.map=[]),r[e]&&r[e].location&&-1===r.map.indexOf(e)&&r.map.push(e)},T=(e,t)=>{m(e,()=>{t?(t(),m("➜",()=>{M(r.currentLocationName)(),r.isTalking=""})):(M(r.currentLocationName)(),r.isTalking="")})},I=e=>{r.env=e},S=e=>{var t=document.getElementById("page");if(t)if(Array.isArray(e)){var a=e;const s=a[0];var o="i"+(()=>{let e=0;if(0!=s.length)for(i=0;i<s.length;i++){var t=s.charCodeAt(i);e=(e<<5)-e+t,e&=e}return e})(),n=r[o]??0;n?(S(a[n]),n<a.length-1&&(r[o]=n+1)):(r[o]=1,S(s))}else"string"==typeof e?t.innerHTML+=l(e):"function"==typeof e&&(t.innerHTML+=l(e()))},M=t=>{const a=()=>{Object.keys(r).map(e=>{var t,a;r[e]?.location&&r.currentLocationName===r[e]?.location&&(t=(e=>{e=e||r.isTalking;var[t,,a]=p(e),o=r[e].state??"talk";if(!g(e)&&r[e].notMet){if("function"==typeof r[e].notMet)return r[e].notMet();if("object"==typeof r[e].notMet&&r[e].notMet[o]){if("function"==typeof r[e].notMet[o])return r[e].notMet[o]();if("string"==typeof r[e].notMet[o])return r[e].notMet[o]}return r[e].notMet??y(a+` ${t} is here.`)}if("function"==typeof r[e].desc)return r[e].desc();if("object"==typeof r[e].desc&&r[e].desc[o]){if("function"==typeof r[e].desc[o])return r[e].desc[o]();if("string"==typeof r[e].desc[o])return r[e].desc[o]}return r[e].desc??y(a+` ${t} is here.`)})(e),S(t),r[e].talk)&&m((e=>{e=e||r.isTalking;var[t,,a,,]=p(e);return r[e].talkLabel?"string"==typeof r[e].talkLabel?r[e].talkLabel:r[e].talkLabel():`Talk to ${a} `+t})(e),(a=e,()=>{r.isTalking=a,(s=r[a]).hasMet=!0;var e=s?.state??"talk";k(),1!==r?.map?.length||r.showFastTravelTip||(r.showFastTravelTip=1),r[a][e](),r.lastNode=r[a][e]}),!0)})};return()=>{r.currentLocationName=t;var e=()=>{var e=r[t]?.visited??0;r.env=null,r.isTalking="",r[t](),a(),r[t].visited=e+1,1===r.showFastTravelTip&&r[r.map[0]].location!==r.currentLocationName&&(r.showFastTravelTip=2,L("Hey there! You can now fast travel to characters you meet by tapping the top ⤴ of the screen"))};e(),r.lastNode=e}},x=e=>e>=Math.floor(100*Math.random());const A=e=>{var t=`p{${h(e.join("-"))}}`;return r[t]&&r[t]?.length||(r[t]=(e=>{let t=e.length,a;for(;0!=t;)a=Math.floor(Math.random()*t),t--,[e[t],e[a]]=[e[a],e[t]];return e})([...e])),r[t].pop()},L=e=>{const t=document.createElement("div");t.className="tipBox",t.id="tipBox";var a=document.createElement("div"),o=(a.className="tipInnerBox",a.id="tipInnerBox",document.createElement("div"));o.className="tipInnerText",o.id="tipInnerText",o.innerText=e,a.appendChild(o),t.appendChild(a),t.onclick=()=>t.remove(),document.body.appendChild(t)},E=e=>(r.values||(r.values={}),r.values[e]??!1),N=(e,t)=>{r.values||(r.values={}),r.values[e]=t};