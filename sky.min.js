let n=!1;const t=()=>{if(!n){const a=document.createElement("div"),o=(a.className="menu",document.createElement("div"));o.style=`
  ...
  `}),c({"Climb back up towards the village":S("cityEntrance")}),c({"Enter the swamp":S("nearSwamp")})},Game.library=()=>{I(`
    ...
    `),c({"Climb down to the Main Deck":S("mainDeck")}),c({"Sit in the chair":"You sit in the command chair and feel very heroic."}),c({"Look out the window":"The purple sky and distant golden mountains don't resemble any planet you've visited before."})},Game.mainDeck=()=>{I(`
