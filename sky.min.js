Game.loon={name:"green man",location:"nearSwamp",exitText:"Nice chatting with you",notMet:()=>T(`
  ...
  `),talk:()=>{k(`
    ...
    `),a("Loon"),e("Just in time for what?",()=>{T(`
    ...
    `),b("Have a good day scooping mud")}};Game.mavis={name:"giant brain in a jar",exitText:"Thanks for your help",location:"library",superMegaBlastLearning:!1,bookAskCount:0,notMet:()=>`
    ...
    `,talk:()=>{k(`
        ...
        `),h("Why haven't you got any books?",()=>{m.bookAskCount<2&&(m.bookAskCount+=1),k(`
            ...
            `)}),1<m.bookAskCount&&h("What's the Super MegaBlast Learning Hat?",()=>{m.superMegaBlastLearning=!0,T(`"I shouldn't even mention it," said Mavis, "Because even if you survive
                it, you'll lose everything you learned in like half an hour.`)}),m.superMegaBlastLearning&&h("Let me try the hat!",()=>{t()<2?T("No!"):T("OK.")}),b(m.exitText)}},Game.merrick={name:"frat scientist",exitText:"Uh, carry on I guess",desc:()=>{d("merrick")?T(`
      ...
      `),a("Merrick"),h("What are you mixing?",()=>{T(`
        ...
        `),h("Let me try it",()=>{T(`
          ...
          `),h("Blarrf!",()=>{T(`
            ...
            `)}),h("Huuurggg!",()=>{T('"Not perfect yet," mumbled Merrick. "Needs more absinthe and strychnine."')}),h(`Excuse me. Can you direct me to the nearest bipedal-friendly
          porcelain commode?`,()=>{T(`Merrick slowly transforms into an enormous Kafkaesque toilet. "What did you
        ...
        `)}),b(m.exitText)}},Game.rebnah={exitText:"Nice chatting with you",hasTheToken:!1,location:"cityEntrance",name:"greeter hologram",talkLabel:()=>{var[e,,t,,]=n("rebnah");return`Chat with ${t} `+e},notMet:()=>{return`
      ...
      `},desc:()=>`
        ...
        Rebnah the greeter hologram waves to you cheerily, which is impressive considering her vast quantity of arms. ${S(25)?`She 
              emits a thunderous snort and rubs her fantastic nose.`:""}
              
    `,talk:()=>{m.hasTheToken=!0,k(`
      ...
      `),m.hasTheToken&&e("Read the token",`
          ...
          `),b("See you later")},afterShipDestroyed:()=>{T(`
              
    Rebnah the greeter hologram offers a wan smile, seemingly aware that you're having a rough day.
    
    `),h("Do you just pop in and out of existence like that all the time?",()=>{m.exitText="Well, it's been a... pleasure, I guess",T(`
      ...
      `)}),b(m.exitText)}},Game.spaceKing={preventWar:!1,name:"man",talk:()=>{a("Space King"),k(`
        ...
        `),h("Did you have the moral right to create a living thing?",()=>{T(`
          ...
          `)})}),m.preventWar&&h("So what are you doing to prevent war?",`
              ...
              `),e("What are you doing *here* of all places?",()=>{m.preventWar=!0,T(`
        ...
        `)}),b("A pleasure to talk to you, oh Space King")}},Game.yates={askedAboutName:!1,talk:()=>{var e=m.askedAboutName?"Tell me again why your name is Yates":"So, I've never asked: why are you named *Yates*?";T(`
        ...
        `)}),h("Will you hurry up already?",()=>{f("yates","annoyed"),T(`"I'm working as fast as I can," he grumbled.`)}),b("Well, keep working, we've got to get off this rock",()=>{T("Yates nods and buries himself in repair work. A shadow of paranoia crosses your mind that he may not know what he's doing.")})},annoyed:()=>{T(`
      ...
      `),h("Thank you for working so hard, Yates",()=>{f("yates","talk"),T(`
        ...
        `)}),b("Well, keep working, we've got to get off this rock")}},Game.city=()=>{T(`
    ...
    `),S(75)&&T(A(["Boom! Boom! Boom! The base from the micro-sized festival echoes down the street.",`You can hear what sounds like tiny screams from the festival ahead. Either people are
    ...
    `),S(50)&&T(A(["A door quietly shuts somewhere beyond the wall.","The wind whips just enough around the walls to produce a low, sad whistle."])),e("Read the 1000 meter tall sign","The writing is small, you'll have to get closer by heading towards the lake."),h("Head up the hill",()=>p("outsideShip")),h("Follow the path to the lake",()=>p("lakeSide")),h("Enter the village",()=>p("city"))},Game.festival=()=>{var[e,,t,,]=n("merrick");T(`
    ...
    `),u("merrick"),S(50)&&T(A(["An explosion of confetti fills the air, with several colored bits landing on your face.","The crowd cheers, as though someone either drank another flight or passed out."])),h(`Talk to ${t} `+e,()=>w("merrick")),h("Dance with the crowd","OOF! OUCH! HMPH! Arms, tentacles, and other miscellaneous appendages flail into your carbon-based biology as you attempt to cut a rug."),h("Listen to the music","It's tough to hear any lyrics, but it sounds like the "+A([`3rd Movement of Parnassor the Tuneless Suicidal on the Great Ending of Everything Ever.
        ...
        wrote only polkas.`])),h("Leave the festival",()=>p("city"))},Game.lakeSide=()=>{var[e,t,a]=n("spaceKing");T(`
    ...
    `),S(50)&&T(A(["The wind creates soft little ripples over the lake.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),h("Read the incredible sign",`
  ...
  **Here He Is**
  ...
  `),h(`Speak to ${a} `+e,()=>w("spaceKing")),h("Climb back up towards the village",()=>p("cityEntrance")),h("Enter the swamp",()=>p("nearSwamp"))},Game.library=()=>{T(`
    ...
    `),h("Exit the library",()=>p("city"))},Game.nearSwamp=()=>{T(`
      ...
      `),S(50)&&T(A(["A particularly large bubble pops, filling the air with stench.","A loud POP carries over the water as another bubble explodes."])),h("Head towards the cave",()=>p("cave")),h("Go to the clean part of the lake",()=>p("lakeSide"))},Game.myShip={stillHere:!0},Game.cockpit=()=>{T(`
    ...
    `),h("Go to the cockpit",()=>p("cockpit")),h("Exit the ship",()=>p("outsideShip"))},Game.outsideShip=()=>{c.myShip.stillHere?(T(`
    ...
    `),S(50)&&T(A(["A big pink cloud poofs on by over the horizon.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),h("Hey, Yates",()=>w("yates")),h("Admire my ship",`
    ...
    this morning's landing not withstanding. Currently, Yates ${A(["has coolant spilled all over the hull","is tightening bolts on a rusted structural support","pulling a fuel hose from under the engine"])}.
    
    `),h("Enter the ship",()=>p("mainDeck"))):T(`
    ...
    `),h("Go down to the village",()=>p("cityEntrance"))},Game.shipRepairShop=()=>{T(`
    ...
    `),h("Did you say two weeks?",()=>p("outsideShip"))};const s=(e,t=!1)=>{const a=t?"div":"p";return e.split("\n").map(e=>e.trim()).join("\n").split("\n\n").filter(e=>""!==e).map(e=>`<${a}>${(o=>{const n={quote:!0,bold:!0,italic:!0};var e=(e,t,a)=>{for(;-1<o.indexOf(e);)o=n[t]?o.replace(e,`<${a}>`):o.replace(e,`</${a}>`),n[t]=!n[t]},t=(t,a)=>o=o.split("\n").map(e=>0===e.trimStart().indexOf(t)?`<${a}>${e.replace(t,"")}</${a}>`:e).join("\n");return t("#### ","h4"),t("### ","h3"),t("## ","h2"),t("# ","h1"),e('"',"quote","q"),e("**","bold","b"),e("*","italic","i"),o=o.trim()})(e)}</${a}>`).join("")};let r=!1;let l=0;const e=(t,e,a)=>{const o="d"+function(){var e=0;if(0!=t.length)for(i=0;i<t.length;i++)e=(e<<5)-e+(char=t.charCodeAt(i)),e&=e;return e}();c[o]||h(t,()=>{c[o]=!0,T(e)},a)},h=(o,n,e)=>{var t,a=document.getElementById("btns");a&&o&&n&&(l+=1,o=o.trim(),(t=document.createElement("button")).onclick=()=>{var e,t=document.getElementsByClassName("main")[0].innerHTML,a=(v(),backButtonHidden=!0,window.scrollTo(0,0),r=o,c.isTalking&&(a=m?.state??"talk",e=m[a]["btn-"+o]??0,m[a]["btn-"+o]=e+1),document.createElement("div"));a.className="outPage",a.innerHTML=t,document.body.appendChild(a),setTimeout(()=>{document.getElementsByClassName("outPage")[0].remove();var e=document.createElement("div"),t=(e.className="main",document.createElement("div")),a=(t.className="page",t.id="page",document.createElement("btns"));a.className="btns",a.id="btns",document.body.appendChild(e),e.appendChild(t),e.appendChild(a),"string"==typeof n?T(n):n(),!(backButtonHidden=0===l?!1:backButtonHidden)&&y&&h("OK",()=>{y&&y()})},490)},t.className="button",t.innerHTML=`<div class='buttonText'>${s(o,!0)}</div>`,e?a.prepend(t):a.appendChild(t))},o=e=>e[0].toUpperCase()+e.slice(1),t=(e,t,a)=>{return e=e||r,t=t||c.isTalking,a=a||(m.state??"talk"),c[t][a]["btn-"+e]??0},n=e=>{e=e||c.isTalking;var t=c[e].a??"a",a=c[e].the??"the",o=c[e].that??"that";return[c[e].name??"person",t,a,o]},a=(e,t)=>{t=t||c.isTalking,c[t].a="",c[t].the="",c[t].that="",c[t].name=e},d=e=>(e=e||c.isTalking,c[e].hasMet),u=e=>{if(e=e||c.isTalking,!d(e)&&c[e].notMet)return"function"==typeof c[e].notMet?c[e].notMet():c[e].notMet??o(`${a} ${t} is here.`);if("function"==typeof c[e].desc)return c[e].desc();const[t,,a]=n(e);return c[e].desc??o(`${a} ${t} is here.`)};let c={},m={},y=()=>{},g="";const p=e=>{const t=()=>{Object.keys(c).map(e=>{var t,a;c[e].location&&g===c[e].location&&(t=u(e),a=(e=>{e=e||c.isTalking;var[t,,a,,]=n(e);return c[e].talkLabel?"string"==typeof c[e].talkLabel?c[e].talkLabel:c[e].talkLabel():`Talk to ${a} `+t})(e),T(t),c[e].talk)&&h(a,()=>w(e),!0)})};backButtonHidden=!0,g=e;var a=()=>{c[e](),t()};a(),y=a},f=(e,t)=>{t=t??"talk";c[e].state=t,c.isTalking===e&&(y=c[e][t])},w=e=>{c.isTalking=e,(m=c[e]).hasMet=!0;var t=m?.state??"talk";backButtonHidden=!0,c[e][t](),y=c[e][t]},b=(e,t)=>h(e,()=>{t?(t(),h("OK",()=>{p(g),c.isTalking=""})):(p(g),c.isTalking="")}),v=()=>{document.getElementsByClassName("main")[0].remove(),l=0},k=(t,e)=>{var a="i"+function(){var e=0;if(0!=t.length)for(i=0;i<t.length;i++)e=(e<<5)-e+(char=t.charCodeAt(i)),e&=e;return e}();c[a]?T(e):(c[a]=!0,T(t))},T=e=>{"string"==typeof e?document.getElementById("page").innerHTML+=s(e):"function"==typeof e&&(document.getElementById("page").innerHTML+=s(e()))},S=e=>e>=Math.floor(100*Math.random());const A=e=>{return(e=>{let t=e.length,a;for(;0!=t;)a=Math.floor(Math.random()*t),t--,[e[t],e[a]]=[e[a],e[t]];return e})([...e])[0]};window.addEventListener("load",()=>{c={...Game},p("start")});