Game.loon={name:"green man",location:"nearSwamp",exitText:"Nice chatting with you",notMet:()=>S(`
  ...
  `),talk:()=>{T(`
    ...
    `),a("Loon"),e({"Just in time for what?":()=>{S(`
    ...
    `,talk:()=>{T(`
        ...
        `),h({"Why haven't you got any books?":()=>{y.bookAskCount<2&&(y.bookAskCount+=1),T(`
            ...
            `)}}),1<y.bookAskCount&&h({"What's the Super MegaBlast Learning Hat?":()=>{y.superMegaBlastLearning=!0,S(`"I shouldn't even mention it," said Mavis, "Because even if you survive
                it, you'll lose everything you learned in like half an hour.`)}}),y.superMegaBlastLearning&&h({"Let me try the hat!":()=>{t()<2?S("No!"):S("OK.")}}),v(y.exitText)}},Game.merrick={name:"frat scientist",exitText:"Uh, carry on I guess",desc:()=>{d("merrick")?S(`
      ...
      `),a("Merrick"),h({"What are you mixing?":()=>{S(`
        ...
        `),h({"Let me try it":()=>{S(`
          ...
          `),h({"Blarrf!":()=>{S(`
            ...
            `)}}),h({"Huuurggg!":()=>{S('"Not perfect yet," mumbled Merrick. "Needs more absinthe and strychnine."')}}),h({"Excuse me. Can you direct me to the nearest bipedal-friendly porcelain commode?":()=>{S(`Merrick slowly transforms into an enormous Kafkaesque toilet. "What did you
      ...
      `},desc:()=>`
        ...
        Rebnah the greeter hologram waves to you cheerily, which is impressive considering her vast quantity of arms. ${A(25)?`She 
    ...
    `,talk:()=>{y.hasTheToken=!0,T(`
          ...
          `),a("Rebnah"),h({"Tell me about your home planet":()=>{T(`
    ...
    `}),y.hasTheToken&&e("Read the token",`
          ...
          `),v("See you later")},afterShipDestroyed:()=>{S(`
              
    Rebnah the greeter hologram offers a wan smile, seemingly aware that you're having a rough day.
    
    `),h({"Do you just pop in and out of existence like that all the time?":()=>{y.exitText="Well, it's been a... pleasure, I guess",S(`
      ...
      `),h({"That's... horrific...":`
          ...
          `})}}),v(y.exitText)}},Game.spaceKing={preventWar:!1,name:"man",talk:()=>{a("Space King"),T(`
        ...
        `),e("What's the most impressive thing you've ever done?",()=>{S(`
        ...
        `),h({"Did you have the moral right to create a living thing?":()=>{S(`
          
          "I don't know," responded the Space King, "But, I do know this: he was delicious."
          
          `)}}),h({"What kind of pie was it?":()=>{S(`
      ...
      `}),e("What are you doing *here* of all places?",()=>{y.preventWar=!0,S(`
      ...
      `})}),v("A pleasure to talk to you, oh Space King")}},Game.yates={askedAboutName:!1,talk:()=>{y.askedAboutName;S(`
        ...
        `),h({"Tell me again why your name is Yates":()=>{y.askedAboutName=!0,S(`
        ...
        `)}}),h({"Will you hurry up already?":()=>{b("yates","annoyed"),S(`"I'm working as fast as I can," he grumbled.`)}}),v("Well, keep working, we've got to get off this rock",()=>{S("Yates nods and buries himself in repair work. A shadow of paranoia crosses your mind that he may not know what he's doing.")})},annoyed:()=>{S(`
    ...
    `}),h({"Thank you for working so hard, Yates":()=>{b("yates","talk"),S(`
        
        "Thanks. I'm going as fast as I can."
        
        `)}}),v("Well, keep working, we've got to get off this rock")}},Game.city=()=>{S(`
    ...
    `),A(75)&&S(I(["Boom! Boom! Boom! The base from the micro-sized festival echoes down the street.",`You can hear what sounds like tiny screams from the festival ahead. Either people are
    ...
    `}),h({"Find the repair shop":()=>f("shipRepairShop")}),h({"Enter the library":()=>f("library")}),h({"Walk to the festival":()=>{S(`Your skin tingles a bit as you pass through a compression field and
      are shrunk to a couple of millimeters tall
      so as to enter the venue.`),h({"Hey that tickles":()=>f("festival")})}}),h({"Leave the village":()=>f("cityEntrance")})},Game.cityEntrance=()=>{S(`
    ...
    `),A(50)&&S(I(["A door quietly shuts somewhere beyond the wall.","The wind whips just enough around the walls to produce a low, sad whistle."])),e({"Read the 1000 meter tall sign":`
    The writing is small, you'll have to get closer by heading towards the lake.
  `}),h({"Head up the hill":()=>f("outsideShip")}),h({"Follow the path to the lake":()=>f("lakeSide")}),h({"Enter the village":()=>f("city")})},Game.festival=()=>{S(`
    ...
    `),c("merrick"),A(50)&&S(I(["An explosion of confetti fills the air, with several colored bits landing on your face.","The crowd cheers, as though someone either drank another flight or passed out."])),h({"Talk to {the} {name}":()=>w("merrick")}),h({"Dance with the crowd":`
  ...
  `}),h({"Listen to the music":`
    ...
    It's tough to hear any lyrics, but it sounds like the ${I([`3rd Movement of Parnassor the Tuneless Suicidal on the Great Ending of Everything Ever.
  ...
  `}),h({"Leave the festival":()=>f("city")})},Game.lakeSide=()=>{var[e,t]=n("spaceKing"),a={};a[u("spaceKing")]=()=>w("spaceKing"),S(`
  ...
  `),A(50)&&S(I(["The wind creates soft little ripples over the lake.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),h({"Read the incredible sign":`
  ...
  `}),h(a),h({"Climb back up towards the village":()=>f("cityEntrance")}),h({"Enter the swamp":()=>f("nearSwamp")})},Game.library=()=>{S(`
    ...
    `}),h({"Exit the library":()=>f("city")})},Game.nearSwamp=()=>{S(`
      ...
      `),A(50)&&S(I(["A particularly large bubble pops, filling the air with stench.","A loud POP carries over the water as another bubble explodes."])),h({"Head towards the cave":()=>f("cave")}),h({"Go to the clean part of the lake":()=>f("lakeSide")})},Game.myShip={stillHere:!0},Game.cockpit=()=>{S(`
    ...
    `),h({"Climb down to the Main Deck":()=>f("mainDeck")}),h({"Sit in the chair":"You sit in the command chair and feel very heroic."}),h({"Look out the window":"The purple sky and distant golden mountains don't resemble any planet you've visited before."})},Game.mainDeck=()=>{S(`
    ...
    `),h({"Go to the cockpit":()=>f("cockpit")}),h({"Exit the ship":()=>f("outsideShip")})},Game.outsideShip=()=>{m.myShip.stillHere?(S(`
    ...
    `),A(50)&&S(I(["A big pink cloud poofs on by over the horizon.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),h({"Hey, Yates":()=>w("yates")}),h({"Admire my ship":`
    ...
    this morning's landing not withstanding. Currently, Yates ${I(["has coolant spilled all over the hull","is tightening bolts on a rusted structural support","is pulling a fuel hose from under the engine"])}.
    
    `}),h({"Enter the ship":()=>f("mainDeck")})):S(`
    ...
    `),h({"Go down to the village":()=>f("cityEntrance")})},Game.shipRepairShop=()=>{S(`
  ...
  `}),h({"Return to the village":()=>f("city")})},Game.start=()=>{S(`

    # We Might All Die on Snorlag
    
    ## A game by spaceflounder
    
    `),h({Start:()=>f("intro1")})},Game.intro1=()=>{S(`
    ...
    `),h({"Ugghh... It's too early for an emergency...":()=>f("intro2")})},Game.intro2=()=>{S(`
    ...
    `),h({"Yates! What happened?":()=>f("intro3")})},Game.intro3=()=>{S(`
