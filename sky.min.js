let n=!1;const t=()=>{if(!n){const a=document.createElement("div"),o=(a.className="menu",document.createElement("div"));o.style=`
      ...
      align-items: center;
    `;let e=[];r.map&&(e=r.map.sort().filter(e=>r[e]?.location!==r.currentLocationName)).map(t=>{var e;r[t].location&&((e=document.createElement("button")).innerText=r[t].name,e.style="width: 80vw;",e.onclick=()=>{const e=document.createElement("div");e.className="outMenu",e.innerHTML=a.innerHTML,n=!1,a.remove(),d(),u(),S(r[t].location)(),document.body.appendChild(e),setTimeout(()=>{e.remove()},400)},o.appendChild(e))});var t=document.createElement("button");t.style="aspect-ratio: 1; font-size: 32pt; font-weight: bold; width: 64px; height: 64px;",t.innerText="⤒",t.onclick=()=>{n=!1,a.remove();const e=document.createElement("div");e.className="outMenu",e.innerHTML=a.innerHTML,document.body.appendChild(e),setTimeout(()=>{e.remove()},400)},0<e.length&&(o.appendChild(t),a.appendChild(o),document.body.appendChild(a))}};let r={},s={};const l=(e,t=!1)=>{let a=0;const o=t?"div":"p";return e.split("\n").map(e=>e.trim()).join("\n").split("\n\n").filter(e=>""!==e).map(e=>`<${o}>${(o=>{const n={quote:!0,bold:!0,italic:!0};var e=(e,t,a)=>{for(;-1<o.indexOf(e);)o=n[t]?o.replace(e,`<${a}>`):o.replace(e,`</${a}>`),n[t]=!n[t]},t=(t,a)=>o=o.split("\n").map(e=>0===e.trimStart().indexOf(t)?`<${a}>${e.replace(t,"")}</${a}>`:e).join("\n");for(t("#### ","h4"),t("### ","h3"),t("## ","h2"),t("# ","h1");-1<o.indexOf("[[");)o=a%2==0?o.replace("[[","&ldquo;"):o.replace("[[","&lsquo;"),a+=1;for(;-1<o.indexOf("]]");)--a,o=a%2==0?o.replace("]]","&rdquo;"):o.replace("]]","&rsquo;");for(e("``","quote","q"),e('"',"quote","q"),e("**","bold","b"),e("*","italic","i");-1<o.indexOf("'");)o=o.replace("'","&rsquo;");return o=o.trim()})(e)}</${o}>`).join("")};function h(e){var t=0;if(0!=e.length)for(i=0;i<e.length;i++)t=(t<<5)-t+(char=e.charCodeAt(i)),t&=t;return t}Game.loon={name:"green man",location:"nearSwamp",exitText:"Nice chatting with you",notMet:()=>`
  ...
  `,desc:{talk:"Professor Loon is still here, gathering more sludge into tubes. ",annoyed:"Professor Loon is in mud, looking very annoyed about something"},talk:()=>{I([`
    ...
    `]),o("Loon"),e({"Just in time for what?":()=>{I(`
      ...
      `})}}),a("Just in")&&c({"You really can't even give me a tiny hint what you're working on?":()=>{I([`
    ...
    `}),c({"Hey, can I see that crank for a second?":()=>{I(`
        ...
        `})}}),p("merrick")&&a("Just in")&&c({"You know, that Merrick guy at the festival seems like quite a scientist himself":()=>{I(`
          
          Loon snorts. "I can assure you, my friend, Merrick is *no* scientist of any sort."
          
          `),c({"I don't know. He seems on the edge of a breakthrough!":()=>{I(`
            ...
            `),f(""),w("annoyed"),k("Well OK then")}}),c({"If you say so":`
          
          "I'm not worried about competing with that so-called mixologist,"
          said Loon with a chuckle. "We're doing actual science here."
          
          `})}}),k("Have a good day scooping mud")},annoyed:()=>{I(`
    
    "I'm not in the mood to chat right now," said Loon with a scowl.
    
    `),k("Alrighty")}},Game.mavis={name:"giant brain in a jar",location:"library",exitText:"Thanks for your help",hasMet:!1,superMegaBlastLearning:!1,bookAskCount:0,notMet:()=>`
    ...
    `,talk:()=>{o("Mavis"),I([`
        ...
        `]),c({"Why haven't you got any books?":()=>{s.bookAskCount<2&&(s.bookAskCount+=1),I([`
            ...
            `])}}),a("any books")&&c({"Are you really a giant brain?":()=>{I(`
            
            "I should hope that should be obvious..." said Mavis with an edge of annoyance.
            "Why do you ask?"
            
            `),c({"You must get asked some tough questions":()=>{I(`
                
                "Sure," said Mavis. "Mostly about the Dewey Decimal System. Nobody
                understands the Dewey Decimal System."
                
                `),c({"So what's the hardest question you've ever been asked?":()=>{I('"Once," said Mavis, "A snotty 10 year-old Zogtarian came in and asked me a riddle.'),c({"Was it what's the difference between a coffee mug and a doughnut?":`
                    
                    Mavis grumbled: "No, he was a Zogtarian, not a Topzoidian."
                    
                    `}),c({"Was it about how to create a fat-free Mayonnaise-replacement product that delivers on value and flavor?":`
                    
                    "Of course not. We'd already invented Hidden Valley dressing at that point."
                    
                    `}),c({"What was it?":()=>{I('"Only this," said Mavis with a serious tone, "Why is a raven like a writing desk?"'),c({"That's it?":()=>{E("writingDesk",!0),I(`

                        Mavis chuckled. "Oh sure, it seems simple. But it even stumped the Old Man in the Cave."
                        
                        `)}})}})}}),c({"Do you understand the Dewey Decimal System?":`
                
                "Erm... Of course I do," Mavis stammered. "Don't you have something better to do then bug me?"
                
                `})}}),c({"Oh, I just had to ask to be sure.":`
            
            "Your powers of observation have not yet ceased to amaze," said Mavis.
            
            `})}}),k(s.exitText)}},Game.merrick={name:"frat scientist",location:"festival",exitText:"Uh, carry on I guess",desc:()=>{p("merrick")?I(`
      ...
      `]),o("Merrick"),c({"Are you working the bar all by yourself?":`
      ...
      `}),c({"What are you mixing?":()=>{I(`
        ...
        `),c({"Let me try it":()=>{I(`
          ...
          `),c({"Blarrf!":()=>{I(`
            ...
            `)}}),c({"Huuurggg!":()=>{I('"Not perfect yet," mumbled Merrick. "Needs more absinthe and strychnine."')}}),c({"Excuse me. Can you direct me to the nearest bipedal-friendly porcelain commode?":()=>{I(`Merrick slowly transforms into an enormous Kafkaesque toilet. "What did you
        ...
        `})}}),k(s.exitText)}},Game.rebnah={exitText:"Nice chatting with you",hasTheToken:!1,location:"cityEntrance",name:"greeter hologram",talkLabel:()=>{var[e,,t,,]=y("rebnah");return`Chat with ${t} `+e},notMet:()=>{return`
      ...
      `},desc:()=>`
        ...
        Rebnah the greeter hologram waves to you cheerily, which is impressive considering her vast quantity of arms. ${M(25)?`She 
              emits a thunderous snort and rubs her fantastic nose.`:""}
              
    `,talk:()=>{s.hasTheToken=!0,I([`
      ...
      `]),o("Rebnah"),c({"Tell me about your home planet":()=>{I([`
    ...
    `}),s.hasTheToken&&e({"Read the token":`
          ...
          `}),k("See you later")},afterShipDestroyed:()=>{I(`
              
    Rebnah the greeter hologram offers a wan smile, seemingly aware that you're having a rough day.
    
    `),c({"Do you just pop in and out of existence like that all the time?":()=>{s.exitText="Well, it's been a... pleasure, I guess",I(`
      ...
      `),c({"That's... horrific...":`
          ...
          `})}}),k(s.exitText)}},Game.spaceKing={preventWar:!1,location:"lakeSide",name:"very impressive man",notMet:`
  ...
  `,talk:()=>{o("Space King"),I([`
      ...
      `}),e({"What's the most impressive thing you've ever done?":()=>{I(`
        ...
        `),c({"Did you have the moral right to create a living thing?":()=>{I(`
          
          "I don't know," responded the Space King, "But, I do know this: he was delicious."
          
          `)}}),c({"What kind of pie was it?":()=>{I(`
      ...
      `}),e({"What are you doing *here* of all places?":()=>{s.preventWar=!0,I(`
      ...
      `})}}),k("A pleasure to talk to you, oh Space King")}},Game.yates={name:"Yates",location:"outsideShip",talkLabel:"Hey, Yates",hasMet:!0,desc:`
  ...
  `,talk:()=>{I(`
        ...
        `),c({"Tell me again why your name is Yates":()=>{I(`
        ...
        `)}}),c({"Will you hurry up already?":()=>{w("annoyed"),I(`"I'm working as fast as I can," he grumbled.`)}}),k("Well, keep working, we've got to get off this rock",()=>{I("Yates nods and buries himself in repair work. A shade of anxiety crosses your mind that he may not know what he's doing.")})},annoyed:()=>{I(`
    ...
    `}),c({"Thank you for working so hard, Yates":()=>{w(),I(`
        
        "Thanks. I'm going as fast as I can."
        
        `)}}),k("Well, keep working, we've got to get off this rock")}},Game.caveMouth=()=>{I(`
    ...
    `),c({"Enter the cave":()=>{L("caveForceFieldOff")?S("insideCave")():I(`
            ...
            `)}}),c({"Return to the swamp":S("nearSwamp")})},Game.city=()=>{I(`
    ...
    `),T(()=>M(25)&&x(["Boom! Boom! Boom! The base from the micro-sized festival echoes down the street.",`You can hear what sounds like tiny screams from the festival ahead. Either people are
    ...
    `}),c({"Find the repair shop":S("shipRepairShop")}),c({"Enter the library":S("library")}),c({"Walk to the festival":()=>{I(`Your skin tingles a bit as you pass through a compression field and
      are shrunk to a couple of millimeters tall
      so as to enter the venue.`),c({"Hey that tickles":S("festival")})}}),c({"Leave the village":S("cityEntrance")})},Game.cityEntrance=()=>{I(`
    ...
    `),T(()=>M(25)&&x(["A door quietly shuts somewhere beyond the wall.","The wind whips just enough around the walls to produce a low, sad whistle."])),e({"Read the 1000 meter tall sign":`
    The writing is small, you'll have to get closer by heading towards the lake.
  `}),c({"Head up the hill":S("outsideShip")}),c({"Follow the path to the lake":S("lakeSide")}),c({"Enter the village":S("city")})},Game.festival=()=>{I(`
    ...
    `),T(()=>M(25)&&x(["An explosion of confetti fills the air, with several colored bits landing on your face.","The crowd cheers, as though someone either drank another flight or passed out."])),c({"Dance with the crowd":`
  ...
  `}),c({"Listen to the music":`
    ...
    It's tough to hear any lyrics, but it sounds like the ${x([`3rd Movement of Parnassor the Tuneless Suicidal on the Great Ending of Everything Ever.
  ...
  `}),c({"Leave the festival":S("city")})},Game.lakeSide=()=>{var[e,,t]=y("spaceKing");I(`
  ...
  `),T(()=>M(25)&&x(["The wind creates soft little ripples over the lake.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),c({"Read the incredible sign":`
  
    The vast sign says in every known language in the universe, including ✧❖➶⨇⨖⨿⩉:
  
    **Here He Is**

    A gigantic red arrow points to ${t} ${e}.
  
  `}),c({"Climb back up towards the village":S("cityEntrance")}),c({"Enter the swamp":S("nearSwamp")})},Game.library=()=>{I(`
    ...
    `}),c({"Exit the library":S("city")})},Game.nearSwamp=()=>{I(`
      ...
      `),c({"Turn crank":()=>{E("caveForceFieldOff",!0),I(`
        
        The force field control is now in the off position.
        
        `)}})),T(()=>M(25)&&x(["A particularly large bubble pops, filling the air with stench.","A loud POP carries over the water as another bubble explodes."])),c({"Head towards the cave":S("caveMouth",()=>{L("caveForceFieldOff")&&f("nearSwamp",loon)})}),c({"Go to the clean part of the lake":S("lakeSide",()=>{L("caveForceFieldOff")&&f("nearSwamp",loon)})})},Game.myShip={stillHere:!0},Game.cockpit=()=>{I(`
    ...
    `),c({"Sit in the chair":"You sit in the command chair and feel very heroic."}),c({"Look out the window":"The purple sky and distant golden mountains don't resemble any planet you've visited before."}),c({"Climb down to the Main Deck":S("mainDeck")})},Game.mainDeck=()=>{I(`
    ...
    `),c({"Go to the cockpit":S("cockpit")}),c({"Exit the ship":S("outsideShip")})},Game.outsideShip=()=>{I(`
    ...
    `),b()&&M(50)&&I(x(["A big pink cloud poofs on by over the horizon.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),c({"Admire the view":`
  ...
  `}),c({"Assess my ship":`
    ...
    even before this morning's landing. Currently, Yates ${x(["has coolant spilled all over the hull","is tightening bolts on a rusted structural support","is pulling a fuel hose from under the engine"])}.
    
    `}),c({"Enter the ship":S("mainDeck")}),c({"Go down to the village":S("cityEntrance")})},Game.shipRepairShop=()=>{I(`
  ...
  `}),c({"Return to the village":S("city")})},Game.start=()=>{I(`
    ...
    `),c({Start:S("intro1")})},Game.intro1=()=>{I(`
    ...
    `),c({"Ugghh... It's too early for an emergency...":S("intro2")})},Game.intro2=()=>{I(`
    ...
    `),c({"Yates! What happened?":S("intro3")})},Game.intro3=()=>{I(`
    ...
    `),c({"Did you say two weeks?":S("outsideShip")})},window.addEventListener("load",()=>{var e;r={...Game},(e=document.createElement("div")).className="topBar",e.onclick=t,document.body.appendChild(e),u(),S("start")()});const e=e=>{let t=Object.keys(e)[0];const a="d"+h(t);var o;r[a]||((o={})[t]=()=>{r[a]=!0,"function"==typeof e[t]?e[t]():I(e[t])},c(o))},d=()=>{document.getElementsByClassName("main")[0].remove(),r.buttonCount=0},u=()=>{let e=document.getElementsByClassName("topRoot")[0];var t=document.createElement("div"),a=document.createElement("div"),o=document.createElement("btns");e||((e=document.createElement("div")).className="topRoot",document.body.appendChild(e)),e.appendChild(t),t.className="main",t.id="main",a.className="page",a.id="page",o.className="btns",o.id="btns",e.appendChild(t),t.appendChild(a),t.appendChild(o)},c=t=>{var e=document.getElementById("btns");let o="",n=null;const a=["unshift"];if("object"==typeof t){let e=!0;t.l&&(o=t.l,e=!1),t.label&&(o=t.label,e=!1),t.c&&(n=t.c,e=!1),t.callback&&(n=t.callback,e=!1),e&&(o=Object.keys(t).filter(e=>-1===a.indexOf(e))[0],n=t[o])}if(!(e&&o&&n))throw"Button could not be constructed! With options: "+JSON.stringify(t);r.buttonCount||(r.buttonCount=0),r.buttonCount+=1,o=o.trim();var i=document.createElement("button"),t=(i.type="button",i.onclick=()=>{var e=document.getElementsByClassName("main")[0].innerHTML,t=(d(),r.isTalking&&(t=s?.state??"talk",a=s[t]["btn-"+o]??0,r.lastButtonPressed=o,s[t]["btn-"+o]=a+1),document.createElement("div")),a=(t.className="outPage",t.id="outPage",t.innerHTML=e,document.getElementsByClassName("topRoot")[0]);a&&a.appendChild(t),setTimeout(()=>{document.getElementById("outPage").remove(),window.scrollTo(0,0),u(),"function"==typeof n?n():I(n),!r.env||!r.isTalking&&r.buttonCount||I(r.env()),!r.buttonCount&&r.lastNode&&c({"➜":()=>{r.lastNode&&r.lastNode()}})},450)},i.className="button",i.innerHTML=`<div class='buttonText'>${l(o,!0)}</div>`,t.unshift);t?e.prepend(i):e.appendChild(i)},m=e=>e[0].toUpperCase()+e.slice(1);const a=(o,t,e)=>{t=t||r.isTalking;var a=e=>{for(const t of e)if(Array.isArray(o)){for(const a of o)if(-1<t.indexOf(a))return!0}else if(-1<t.indexOf(o))return!0;return!1};if("*"!==(e=e||"*"))return a(Object.keys(r[t][e]).filter(e=>"function"==typeof e).filter(e=>-1<e.indexOf("btn-")));for(const n of Object.keys(r[t]))if(a(Object.keys(r[t][n]).filter(e=>"number"==typeof r[t][n][e]).filter(e=>-1<e.indexOf("btn-"))))return!0;return!1},y=e=>(e=e||r.isTalking,p(e)?[r[e].name,"","",""]:[r[e].name,"a","the","that"]),o=(e,t)=>{t=t||r.isTalking,r[t].name=e},p=e=>(e=e||r.isTalking,r[e].hasMet),g=e=>{return(e?r[e]:s).location},f=(e,t)=>{(t?r[t]:s).location=e},w=(e,t)=>{e=e??"talk";t=t||r.isTalking,r[t].state=e,r.isTalking===t&&(r.lastNode=r[t][e])},b=e=>{return e=e||r.currentLocationName,r[e].visited??0},v=e=>{e=e||r.isTalking,r.map||(r.map=[]),r[e]&&r[e].location&&-1===r.map.indexOf(e)&&r.map.push(e)},k=(e,t)=>{var a={};a[e]=()=>{t?(t(),c({"➜":()=>{S(r.currentLocationName)(),r.isTalking=""}})):(S(r.currentLocationName)(),r.isTalking="")},c(a)},T=e=>{r.env=e},I=e=>{var t=document.getElementById("page");if(t)if(Array.isArray(e)){var a=e;const s=a[0];var o="i"+(()=>{let e=0;if(0!=s.length)for(i=0;i<s.length;i++){var t=s.charCodeAt(i);e=(e<<5)-e+t,e&=e}return e})(),n=r[o]??0;n?(I(a[n]),n<a.length-1&&(r[o]=n+1)):(r[o]=1,I(s))}else"string"==typeof e?t.innerHTML+=l(e):"function"==typeof e&&(t.innerHTML+=l(e()))},S=t=>{const a=()=>{Object.keys(r).map(e=>{var t,a;r[e]?.location&&r.currentLocationName===r[e]?.location&&(t=(e=>{e=e||r.isTalking;var[t,,a]=y(e),o=r[e].state??"talk";if(!p(e)&&r[e].notMet){if("function"==typeof r[e].notMet)return r[e].notMet();if("object"==typeof r[e].notMet&&r[e].notMet[o]){if("function"==typeof r[e].notMet[o])return r[e].notMet[o]();if("string"==typeof r[e].notMet[o])return r[e].notMet[o]}return r[e].notMet??m(a+` ${t} is here.`)}if("function"==typeof r[e].desc)return r[e].desc();if("object"==typeof r[e].desc&&r[e].desc[o]){if("function"==typeof r[e].desc[o])return r[e].desc[o]();if("string"==typeof r[e].desc[o])return r[e].desc[o]}return r[e].desc??m(a+` ${t} is here.`)})(e),I(t),r[e].talk)&&((t={})[(e=>{e=e||r.isTalking;var[t,,a,,]=y(e);return r[e].talkLabel?"string"==typeof r[e].talkLabel?r[e].talkLabel:r[e].talkLabel():`Talk to ${a} `+t})(e)]=(a=e,()=>{r.isTalking=a,(s=r[a]).hasMet=!0;var e=s?.state??"talk";v(),1!==r?.map?.length||r.showFastTravelTip||(r.showFastTravelTip=1),r[a][e](),r.lastNode=r[a][e]}),t.unshift=!0,c(t))})};return()=>{r.currentLocationName=t;var e=()=>{var e=r[t]?.visited??0;r.env=null,r.isTalking="",r[t](),a(),r[t].visited=e+1,1===r.showFastTravelTip&&r[r.map[0]].location!==r.currentLocationName&&(r.showFastTravelTip=2,A("Hey there! You can now fast travel to characters you meet by tapping the top ⤴ of the screen"))};e(),r.lastNode=e}},M=e=>e>=Math.floor(100*Math.random());const x=e=>{var t=`p{${h(e.join("-"))}}`;return r[t]&&r[t]?.length||(r[t]=(e=>{let t=e.length,a;for(;0!=t;)a=Math.floor(Math.random()*t),t--,[e[t],e[a]]=[e[a],e[t]];return e})([...e])),r[t].pop()},A=e=>{const t=document.createElement("div");t.className="tipBox",t.id="tipBox";var a=document.createElement("div"),o=(a.className="tipInnerBox",a.id="tipInnerBox",document.createElement("div"));o.className="tipInnerText",o.id="tipInnerText",o.innerText=e,a.appendChild(o),t.appendChild(a),t.onclick=()=>t.remove(),document.body.appendChild(t)},L=e=>(r.values||(r.values={}),r.values[e]??!1),E=(e,t)=>{r.values||(r.values={}),r.values[e]=t};