Game.loon={name:"green man",location:"nearSwamp",exitText:"Nice chatting with you",notMet:()=>T(`
  ...
  `),talk:()=>{T([`
    ...
    `]),d("Loon"),e({"Just in time for what?":()=>{T(`
      ...
      `})}}),a("Just in")&&h({"You really can't even give me a tiny hint what you're working on?":()=>{T([`
    ...
    `}),h({"Loon is an unusual name, where are you from?":`
    ...
    `}),h({"Hey, can I see that crank for a second?":()=>{T(`
        ...
        `}),h({"I don't think you're going to find anything tromping in the mud anyway":`
        ...
        `})}}),u("merrick")&&a("Just in")&&h({"You know, that Merrick guy at the festival seems like quite a scientist himself":()=>{T(`
          
          Loon snorts. "I can assure you, my friend, Merrick is *no* scientist of any sort."
          
          `),h({"I don't know. He seems on the edge of a breakthrough!":()=>{T(`
            ...
            `),y.location="",v("Well OK then")}}),h({"If you say so":`
          
          "I'm not worried about competing with that so-called mixologist,"
          said Loon with a chuckle. "We're doing actual science here."
          
          `})}}),v("Have a good day scooping mud")}},Game.mavis={name:"giant brain in a jar",exitText:"Thanks for your help",location:"library",superMegaBlastLearning:!1,bookAskCount:0,notMet:()=>`
    ...
    `,talk:()=>{T([`
        ...
        `]),h({"Why haven't you got any books?":()=>{y.bookAskCount<2&&(y.bookAskCount+=1),T([`
            ...
            `])}}),a("any books")&&h({"Are you sure you don''t have any books?":`
        
        "It's not that kind of library," said Mavis.
        
        `}),1<y.bookAskCount&&h({"What's the Super MegaBlast Learning Hat?":()=>{y.superMegaBlastLearning=!0,T(`"I shouldn't even mention it," said Mavis, "Because even if you survive
                it, you'll lose everything you learned in like half an hour.`)}}),0<t("What's the Super MegaBlast Learning Hat?")&&h({"Let me try the hat!":['"You could fry your brain, human," said Mavis.',`"I'm serious about the whole brain-frying thing," said Mavis with a growing
                    edge in her voice.`,()=>{T("Ok, you've had it!")}]}),v(y.exitText)}},Game.merrick={name:"frat scientist",location:"festival",exitText:"Uh, carry on I guess",desc:()=>{u("merrick")?T(`
      ...
      `]),d("Merrick"),h({"Are you working the bar all by yourself?":`
      ...
      `}),h({"What are you mixing?":()=>{T(`
        ...
        `),h({"Let me try it":()=>{T(`
          ...
          `),h({"Blarrf!":()=>{T(`
            ...
            `)}}),h({"Huuurggg!":()=>{T('"Not perfect yet," mumbled Merrick. "Needs more absinthe and strychnine."')}}),h({"Excuse me. Can you direct me to the nearest bipedal-friendly porcelain commode?":()=>{T(`Merrick slowly transforms into an enormous Kafkaesque toilet. "What did you
            say again?" he asked. His seat and lid were acting as a tongue and mouth.`)}})}}),h({"It looks like scummy swamp water":`
        
        "Wow, you're a mixologist as well?" said Merrick, obviously impressed. "Not bad."
        
        `})}}),v(y.exitText)}},Game.rebnah={exitText:"Nice chatting with you",hasTheToken:!1,location:"cityEntrance",name:"greeter hologram",talkLabel:()=>{var[e,,t,,]=n("rebnah");return`Chat with ${t} `+e},notMet:()=>{return`
      ...
      `},desc:()=>`
        ...
        Rebnah the greeter hologram waves to you cheerily, which is impressive considering her vast quantity of arms. ${I(25)?`She 
              emits a thunderous snort and rubs her fantastic nose.`:""}
              
    `,talk:()=>{y.hasTheToken=!0,T([`
      ...
      `]),d("Rebnah"),h({"Tell me about your home planet":()=>{T([`
    ...
    `}),y.hasTheToken&&e({"Read the token":`
          ...
          `}),v("See you later")},afterShipDestroyed:()=>{T(`
              
    Rebnah the greeter hologram offers a wan smile, seemingly aware that you're having a rough day.
    
    `),h({"Do you just pop in and out of existence like that all the time?":()=>{y.exitText="Well, it's been a... pleasure, I guess",T(`
      ...
      `),h({"That's... horrific...":`
          ...
          `})}}),v(y.exitText)}},Game.spaceKing={preventWar:!1,name:"man",talk:()=>{d("Space King"),T([`
      ...
      `]),e({"Never heard of you":`
        ...
        `),e({"What's the most impressive thing you've ever done?":()=>{T(`
      ...
      `}),e({"What are you doing *here* of all places?":()=>{y.preventWar=!0,T(`
      ...
      `})}}),v("A pleasure to talk to you, oh Space King")}},Game.yates={askedAboutName:!1,talk:()=>{y.askedAboutName;T(`
        ...
        `),h({"Tell me again why your name is Yates":()=>{y.askedAboutName=!0,T(`
        ...
        `)}}),h({"Will you hurry up already?":()=>{f("yates","annoyed"),T(`"I'm working as fast as I can," he grumbled.`)}}),v("Well, keep working, we've got to get off this rock",()=>{T("Yates nods and buries himself in repair work. A shadow of paranoia crosses your mind that he may not know what he's doing.")})},annoyed:()=>{T(`
      
      Yates glares at you as he keeps working. He seemed pretty annoyed.
      
      `),h({"Can't you work any faster?":`
      
      "I don't want to be stuck on this stupid planet, either," said Yates with a sour look.
      
    `}),h({"Thank you for working so hard, Yates":()=>{f("yates","talk"),T(`
        
        "Thanks. I'm going as fast as I can."
        
        `)}}),v("Well, keep working, we've got to get off this rock")}},Game.caveMouth=()=>{T(`
    ...
    `),h({"Enter the cave":()=>{m.caveForceFieldOff?p("insideCave")():T(`
            ...
            `)}}),h({"Return to the swamp":p("nearSwamp")})},Game.city=()=>{T(`
    ...
    `),w()&&I(75)&&T(A(["Boom! Boom! Boom! The base from the micro-sized festival echoes down the street.",`You can hear what sounds like tiny screams from the festival ahead. Either people are
      depressed over the end of the universe or they're having a pretty good time.`,"The music peaks from the festival, followed by a small but thunderous cheer."])),h({"Read the hastily scrawled sign":`
    ...
    `}),h({"Find the repair shop":p("shipRepairShop")}),h({"Enter the library":p("library")}),h({"Walk to the festival":()=>{T(`Your skin tingles a bit as you pass through a compression field and
      are shrunk to a couple of millimeters tall
      so as to enter the venue.`),h({"Hey that tickles":p("festival")})}}),h({"Leave the village":p("cityEntrance")})},Game.cityEntrance=()=>{T(`
    ...
    `),w()&&I(50)&&T(A(["A door quietly shuts somewhere beyond the wall.","The wind whips just enough around the walls to produce a low, sad whistle."])),e({"Read the 1000 meter tall sign":`
    The writing is small, you'll have to get closer by heading towards the lake.
  `}),h({"Head up the hill":p("outsideShip")}),h({"Follow the path to the lake":p("lakeSide")}),h({"Enter the village":p("city")})},Game.festival=()=>{T(`
    ...
    `),w()&&I(50)&&T(A(["An explosion of confetti fills the air, with several colored bits landing on your face.","The crowd cheers, as though someone either drank another flight or passed out."])),h({"Dance with the crowd":`
  ...
  `}),h({"Leave the festival":p("city")})},Game.lakeSide=()=>{var[e,t,a]=n("spaceKing"),o={};o[c("spaceKing")]=b("spaceKing"),T(`
  ...
  `),w()&&I(50)&&T(A(["The wind creates soft little ripples over the lake.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),h({"Read the incredible sign":`
  ...
  `}),h(o),h({"Climb back up towards the village":p("cityEntrance")}),h({"Enter the swamp":p("nearSwamp")})},Game.library=()=>{T(`
    ...
    `}),h({"Exit the library":p("city")})},Game.nearSwamp=()=>{T(`
      ...
      `),"nearSwamp"!==m.loon.location&&(T(`
      
      On the exact spot where Loon was standing is a large metal crank in the mud
      labeled *FORCE FIELD CONTROL*.

      `),h({"Turn crank":()=>{m.caveForceFieldOff=!0,T(`
        
        The force field control is now in the off position.
        
        `)}})),w()&&I(50)&&T(A(["A particularly large bubble pops, filling the air with stench.","A loud POP carries over the water as another bubble explodes."])),h({"Head towards the cave":p("caveMouth",()=>{$g.caveForceFieldOff&&(m.loon.location="nearSwamp")})}),h({"Go to the clean part of the lake":p("lakeSide",()=>{$g.caveForceFieldOff&&(m.loon.location="nearSwamp")})})},Game.myShip={stillHere:!0},Game.cockpit=()=>{T(`
    ...
    `),h({"Climb down to the Main Deck":p("mainDeck")}),h({"Sit in the chair":"You sit in the command chair and feel very heroic."}),h({"Look out the window":"The purple sky and distant golden mountains don't resemble any planet you've visited before."})},Game.mainDeck=()=>{T(`
    ...
    `),h({"Go to the cockpit":p("cockpit")}),h({"Exit the ship":p("outsideShip")})},Game.outsideShip=()=>{T(`
    ...
    `),w()&&I(50)&&T(A(["A big pink cloud poofs on by over the horizon.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),h({"Hey, Yates":b("yates")}),h({"Admire the view":`
  ...
  `}),h({"Assess my ship":`
    ...
    this morning's landing not withstanding. Currently, Yates ${A(["has coolant spilled all over the hull","is tightening bolts on a rusted structural support","is pulling a fuel hose from under the engine"])}.
    
    `}),h({"Enter the ship":p("mainDeck")}),h({"Go down to the village":p("cityEntrance")})},Game.shipRepairShop=()=>{T(`
  ...
  `}),h({"Return to the village":p("city")})},Game.start=()=>{T(`
    ...
    `),h({"Ugghh... It's too early for an emergency...":p("intro2")})},Game.intro2=()=>{T(`
    ...
    `),h({"Yates! What happened?":p("intro3")})},Game.intro3=()=>{T(`
    ...
    `),h({"Did you say two weeks?":p("outsideShip")})};const s=(e,t=!1)=>{const a=t?"div":"p";return e.split("\n").map(e=>e.trim()).join("\n").split("\n\n").filter(e=>""!==e).map(e=>`<${a}>${(o=>{const n={quote:!0,bold:!0,italic:!0};var e=(e,t,a)=>{for(;-1<o.indexOf(e);)o=n[t]?o.replace(e,`<${a}>`):o.replace(e,`</${a}>`),n[t]=!n[t]},t=(t,a)=>o=o.split("\n").map(e=>0===e.trimStart().indexOf(t)?`<${a}>${e.replace(t,"")}</${a}>`:e).join("\n");return t("#### ","h4"),t("### ","h3"),t("## ","h2"),t("# ","h1"),e('"',"quote","q"),e("**","bold","b"),e("*","italic","i"),o=o.trim()})(e)}</${a}>`).join("")};let r=!1;let l=0;const e=(e,t)=>{let a=Object.keys(e)[0];const o="d"+function(){var e=0;if(0!=a.length)for(i=0;i<a.length;i++)e=(e<<5)-e+(char=a.charCodeAt(i)),e&=e;return e}();var n;m[o]||((n={})[a]=()=>{m[o]=!0,"function"==typeof e[a]?e[a]():T(e[a])},h(n,t))},h=(e,t)=>{var a=document.getElementById("btns");let o="",n=null;"object"==typeof e&&(o=Object.keys(e)[0],n=e[o]),a&&o&&n&&(l+=1,o=o.trim(),(e=document.createElement("button")).onclick=()=>{var e,t=document.getElementsByClassName("main")[0].innerHTML,a=(k(),backButtonHidden=!0,r=o,m.isTalking&&(a=y?.state??"talk",e=y[a]["btn-"+o]??0,y[a]["btn-"+o]=e+1),document.createElement("div"));a.className="outPage",a.innerHTML=t,document.body.appendChild(a),setTimeout(()=>{document.getElementsByClassName("outPage")[0].remove();var e=document.createElement("div"),t=(e.className="main",document.createElement("div")),a=(t.className="page",t.id="page",document.createElement("btns"));a.className="btns",a.id="btns",document.body.appendChild(e),e.appendChild(t),e.appendChild(a),"function"==typeof n?n():T(n),!(backButtonHidden=0===l?!1:backButtonHidden)&&g&&h({"➜":()=>{g&&g()}})},490)},e.className="button",e.innerHTML=`<div class='buttonText'>${s(o,!0)}</div>`,t?a.prepend(e):a.appendChild(e))},o=e=>e[0].toUpperCase()+e.slice(1),t=(e,t,a)=>{return e=e||r,t=t||m.isTalking,a=a||(y.state??"talk"),m[t][a]["btn-"+e]??0},a=(o,t,e)=>{t=t||m.isTalking;var a=e=>{for(const t of e)if(Array.isArray(o)){for(const a of o)if(-1<t.indexOf(a))return!0}else if(-1<t.indexOf(o))return!0;return!1};if("*"!==(e=e||"*"))return a(Object.keys(m[t][e]).filter(e=>"function"==typeof e).filter(e=>-1<e.indexOf("btn-")));for(const n of Object.keys(m[t]))if(a(Object.keys(m[t][n]).filter(e=>"number"==typeof m[t][n][e]).filter(e=>-1<e.indexOf("btn-"))))return!0;return!1},n=e=>{e=e||m.isTalking;var t=m[e].a??"a",a=m[e].the??"the",o=m[e].that??"that";return[m[e].name??"person",t,a,o]},d=(e,t)=>{t=t||m.isTalking,m[t].a="",m[t].the="",m[t].that="",m[t].name=e},u=e=>(e=e||m.isTalking,m[e].hasMet),c=e=>{e=e||m.isTalking;var[t,,a,,]=n(e);return m[e].talkLabel?"string"==typeof m[e].talkLabel?m[e].talkLabel:m[e].talkLabel():`Talk to ${a} `+t};let m={};let y={},g=()=>{};const p=t=>{const a=()=>{Object.keys(m).map(e=>{var t;m[e].location&&m.currentLocationName===m[e].location&&(t=(e=>{if(e=e||m.isTalking,!u(e)&&m[e].notMet)return"function"==typeof m[e].notMet?m[e].notMet():m[e].notMet??o(`${a} ${t} is here.`);if("function"==typeof m[e].desc)return m[e].desc();const[t,,a]=n(e);return m[e].desc??o(`${a} ${t} is here.`)})(e),T(t),m[e].talk)&&((t={})[c(e)]=b(e),h(t,!0))})};return()=>{m.currentLocationName=t;var e=()=>{var e=m[t].visited??0;m[t](),a(),m[t].visited=e+1};e(),g=e}},f=(e,t)=>{t=t??"talk";m[e].state=t,m.isTalking===e&&(g=m[e][t])},w=e=>{return e=e||m.currentLocationName,m[e].visited??0},b=t=>()=>{m.isTalking=t,(y=m[t]).hasMet=!0;var e=y?.state??"talk";backButtonHidden=!0,m[t][e](),g=m[t][e]},v=(e,t)=>{var a={};a[e]=()=>{t?(t(),h({"➜":()=>{p(m.currentLocationName)(),m.isTalking=""}})):(p(m.currentLocationName)(),m.isTalking="")},h(a)},k=()=>{document.getElementsByClassName("main")[0].remove(),window.scrollTo(0,0),l=0},T=e=>{if(Array.isArray(e)){var t=e;const n=t[0];var a="i"+(()=>{let e=0;if(0!=n.length)for(i=0;i<n.length;i++){var t=n.charCodeAt(i);e=(e<<5)-e+t,e&=e}return e})(),o=m[a]??0;o?(T(t[o]),o<t.length-1&&(m[a]=o+1)):(m[a]=1,T(n))}else"string"==typeof e?document.getElementById("page").innerHTML+=s(e):"function"==typeof e&&(document.getElementById("page").innerHTML+=s(e()))},I=e=>e>=Math.floor(100*Math.random());const A=e=>{return(e=>{let t=e.length,a;for(;0!=t;)a=Math.floor(Math.random()*t),t--,[e[t],e[a]]=[e[a],e[t]];return e})([...e])[0]};window.addEventListener("load",()=>{m={...Game},p("start")()});