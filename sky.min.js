Game.loon={name:"green man",location:"nearSwamp",exitText:"Nice chatting with you",notMet:()=>b(`
  ...
  `),talk:()=>{w(`
    ...
    `),t("Loon"),e("Just in time for what?",()=>{b(`
    ...
    `),s("Loon is an unusual name, where are you from?",`
    ...
    `),p("Have a good day scooping mud")}},Game.merrick={name:"frat scientist",exitText:"Uh, carry on I guess",desc:()=>{l("merrick")?b(`
      ...
      `),t("Merrick"),s("What are you mixing?",()=>{b(`
        ...
        `),s("It looks like scummy swamp water",`
        
        "Wow, you're a mixologist as well?" said Merrick, obviously impressed. "Not bad."
        
        `)}),p(a.exitText)}},Game.rebnah={exitText:"Nice chatting with you",hasTheToken:!1,location:"cityEntrance",name:"greeter hologram",talkLabel:()=>{var[e,,t,,]=r("rebnah");return`Chat with ${t} `+e},notMet:()=>{return`
      ...
      `},desc:()=>`
        ...
        Rebnah the greeter hologram waves to you cheerily, which is impressive considering her vast quantity of arms. ${v(25)?`She 
              emits a thunderous snort and rubs her fantastic nose.`:""}
              
    `,talk:()=>{a.hasTheToken=!0,w(`
          ...
          `),t("Rebnah"),s("Tell me about your home planet",()=>{w(`
      ...
      `),a.hasTheToken&&e("Read the token",()=>{b(`
                  ...
                  `)}),p("See you later")},afterShipDestroyed:()=>{b(`
              
    Rebnah the greeter hologram offers a wan smile, seemingly aware that you're having a rough day.
    
    `),s("Do you just pop in and out of existence like that all the time?",()=>{a.exitText="Well, it's been a... pleasure, I guess",b(`
      ...
      `)}),p(a.exitText)}},Game.spaceKing={preventWar:!1,name:"man",talk:()=>{t("Space King"),w(`
        ...
        `),e("What's the most impressive thing you've ever done?",()=>{b(`
        ...
        `),s("Did you have the moral right to create a living thing?",()=>{b(`
          ...
          `)})}),a.preventWar&&s("So what are you doing to prevent war?",`
              ...
              `),e("What are you doing *here* of all places?",()=>{a.preventWar=!0,b(`
        ...
        `)}),p("A pleasure to talk to you, oh Space King")}},Game.yates={askedAboutName:!1,talk:()=>{var e=a.askedAboutName?"Tell me again why your name is Yates":"So, I've never asked: why are you named *Yates*?";b(`
        ...
        `)}),s("Will you hurry up already?",()=>{y("yates","annoyed"),b(`"I'm working as fast as I can," he grumbled.`)}),p("Well, keep working, we've got to get off this rock",()=>{b("Yates nods and buries himself in repair work. A shadow of paranoia crosses your mind that he may not know what he's doing.")})},annoyed:()=>{b(`
      
      Yates glares at you as he keeps working. He seemed pretty annoyed.
      
      `),s("Can't you work any faster?",`
      
      "I don't want to be stuck on this stupid planet, either," said Yates with a sour look.
      
      `),s("Thank you for working so hard, Yates",()=>{y("yates","talk"),b(`
        
        "Thanks. I'm going as fast as I can."
        
        `)}),p("Well, keep working, we've got to get off this rock")}},Game.city=()=>{b(`
    ...
    `),v(75)&&b(k(["Boom! Boom! Boom! The base from the micro-sized festival echoes down the street.",`You can hear what sounds like tiny screams from the festival ahead. Either people are
      depressed over the end of the universe or they're having a pretty good time.`,"The music peaks from the festival, followed by a small but thunderous cheer."])),s("Read the hastily scrawled sign",`
    ...
    `),s("Find the repair shop",()=>m("shipRepairShop")),s("Walk to the festival",()=>{b(`Your skin tingles a bit as you pass through a compression field and are shrunk to a couple of millimeters tall
      so as to enter the venue.`),s("Hey that tickles",()=>m("festival"))}),s("Leave the village",()=>m("cityEntrance"))},Game.cityEntrance=()=>{b(`
    ...
    `),v(50)&&b(k(["A door quietly shuts somewhere beyond the wall.","The wind whips just enough around the walls to produce a low, sad whistle."])),e("Read the 1000 meter tall sign","The writing is small, you'll have to get closer by heading towards the lake."),s("Head up the hill",()=>m("outsideShip")),s("Follow the path to the lake",()=>m("lakeSide")),s("Enter the village",()=>m("city"))},Game.festival=()=>{var[e,,t,,]=r("merrick");b(`
    ...
    `),h("merrick"),v(50)&&b(k(["An explosion of confetti fills the air, with several colored bits landing on your face.","The crowd cheers, as though someone either drank another flight or passed out."])),s(`Talk to ${t} `+e,()=>g("merrick")),s("Dance with the crowd","OOF! OUCH! HMPH! Arms, tentacles, and other miscellaneous appendages flail into your carbon-based biology as you attempt to cut a rug."),s("Listen to the music","It's tough to hear any lyrics, but it sounds like the "+k([`3rd Movement of Parnassor the Tuneless Suicidal on the Great Ending of Everything Ever.
        ...
        wrote only polkas.`])),s("Leave the festival",()=>m("city"))},Game.lakeSide=()=>{var[e,t,a]=r("spaceKing");b(`
    ...
    `),v(50)&&b(k(["The wind creates soft little ripples over the lake.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),s("Read the incredible sign",`
  ...
  **Here He Is**
  ...
  `),s(`Speak to ${a} `+e,()=>g("spaceKing")),s("Climb back up towards the village",()=>m("cityEntrance")),s("Enter the swamp",()=>m("nearSwamp"))},Game.nearSwamp=()=>{b(`
      ...
      `),v(50)&&b(k(["A particularly large bubble pops, filling the air with stench.","A loud POP carries over the water as another bubble explodes."])),s("Head towards the cave",()=>m("cave")),s("Go to the clean part of the lake",()=>m("lakeSide"))},Game.myShip={stillHere:!0},Game.cockpit=()=>{b(`
    ...
    `),s("Climb down to the Main Deck",()=>m("mainDeck")),s("Sit in the chair","You sit in the command chair and feel very heroic."),s("Look out the window","The purple sky and distant golden mountains don't resemble any planet you've visited before.")},Game.mainDeck=()=>{b(`
    ...
    `),s("Go to the cockpit",()=>m("cockpit")),s("Exit the ship",()=>m("outsideShip"))},Game.outsideShip=()=>{d.myShip.stillHere?(b(`
    ...
    `),v(50)&&b(k(["A big pink cloud poofs on by over the horizon.","A gentle breeze blows peacefully.","Some distant animal squawks mournfully from the valley below."])),s("Hey, Yates",()=>g("yates")),s("Admire my ship",`
    ...
    this morning's landing not withstanding. Currently, Yates ${k(["has coolant spilled all over the hull","is tightening bolts on a rusted structural support","pulling a fuel hose from under the engine"])}.
    
    `),s("Enter the ship",()=>m("mainDeck"))):b(`
    ...
    `),s("Go down to the village",()=>m("cityEntrance"))},Game.shipRepairShop=()=>{b(`
    ...
    `),s("Ugghh... It's too early for an emergency...",()=>m("intro2"))},Game.intro2=()=>{b(`
    ...
    `),s("Yates! What happened?",()=>m("intro3"))};let n=!(Game.intro3=()=>{b(`
    ...
    `),s("Did you say two weeks?",()=>m("outsideShip"))});const e=(t,e,a)=>{const o="d"+function(){var e=0;if(0!=t.length)for(i=0;i<t.length;i++)e=(e<<5)-e+(char=t.charCodeAt(i)),e&=e;return e}();d[o]||s(t,()=>{d[o]=!0,b(e)},a)},s=(e,t,a)=>{var o,i=document.getElementById("card");i&&e&&t&&(e=e.trim(),(o=document.createElement("button")).onclick=()=>{f(),n=!0,window.scrollTo(0,0),"string"==typeof t?b(t):t(),!(n=""===document.getElementById("card").innerHTML?!1:n)&&u&&s("OK",()=>{u&&u()})},o.className="button",o.innerHTML=`<div class='buttonText'>${T(e,!0)}</div>`,a?i.prepend(o):i.appendChild(o))},o=e=>e[0].toUpperCase()+e.slice(1),r=e=>{e=e||d.isTalking;var t=d[e].a??"a",a=d[e].the??"the",o=d[e].that??"that";return[d[e].name??"person",t,a,o]},t=(e,t)=>{t=t||d.isTalking,d[t].a="",d[t].the="",d[t].that="",d[t].name=e},l=e=>(e=e||d.isTalking,d[e].hasMet),h=e=>{if(e=e||d.isTalking,!l(e)&&d[e].notMet)return"function"==typeof d[e].notMet?d[e].notMet():d[e].notMet??o(`${a} ${t} is here.`);if("function"==typeof d[e].desc)return d[e].desc();const[t,,a]=r(e);return d[e].desc??o(`${a} ${t} is here.`)};let d={},a={},u=()=>{},c="";const m=e=>{const t=()=>{Object.keys(d).map(e=>{var t,a;d[e].location&&c===d[e].location&&(t=h(e),a=(e=>{e=e||d.isTalking;var[t,,a,,]=r(e);return d[e].talkLabel?"string"==typeof d[e].talkLabel?d[e].talkLabel:d[e].talkLabel():`Talk to ${a} `+t})(e),b(t),d[e].talk)&&s(a,()=>g(e),!0)})};n=!0,c=e;var a=()=>{d[e](),t()};a(),u=a},y=(e,t)=>{t=t??"_";d[e].state=t,d.isTalking===e&&(u=d[e][t])},g=e=>{d.isTalking=e,(a=d[e]).hasMet=!0;var t=a?.state??"talk";n=!0,d[e][t](),u=d[e][t]},p=(e,t)=>s(e,()=>{t?(t(),s("OK",()=>{m(c),d.isTalking=""})):(m(c),d.isTalking="")}),f=()=>{document.getElementById("page").innerHTML="",document.getElementById("card").innerHTML=""},w=(t,e)=>{var a="i"+function(){var e=0;if(0!=t.length)for(i=0;i<t.length;i++)e=(e<<5)-e+(char=t.charCodeAt(i)),e&=e;return e}();d[a]?b(e):(d[a]=!0,b(t))},b=e=>{"string"==typeof e?document.getElementById("page").innerHTML+=T(e):"function"==typeof e&&(document.getElementById("page").innerHTML+=T(e()))},v=e=>e>=Math.floor(100*Math.random());const k=e=>{return(e=>{let t=e.length,a;for(;0!=t;)a=Math.floor(Math.random()*t),t--,[e[t],e[a]]=[e[a],e[t]];return e})([...e])[0]},T=(e,t=!1)=>{const a=t?"div":"p";return e.split("\n").map(e=>e.trim()).join("\n").split("\n\n").filter(e=>""!==e).map(e=>`<${a}>${(o=>{const i={quote:!0,bold:!0,italic:!0};var e=(e,t,a)=>{for(;-1<o.indexOf(e);)o=i[t]?o.replace(e,`<${a}>`):o.replace(e,`</${a}>`),i[t]=!i[t]},t=(t,a)=>o=o.split("\n").map(e=>0===e.trimStart().indexOf(t)?`<${a}>${e.replace(t,"")}</${a}>`:e).join("\n");return t("#### ","h4"),t("### ","h3"),t("## ","h2"),t("# ","h1"),e('"',"quote","q"),e("**","bold","b"),e("*","italic","i"),o=o.trim()})(e)}</${a}>`).join("")};window.addEventListener("load",()=>{d={...Game},m("start")}),Game.library=()=>{b(`
